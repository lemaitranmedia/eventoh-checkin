(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&c(d)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const ne="OH2026",ae="oh_ci_v5",J="https://kpzwmancieemefcvgtkm.supabase.co",ve="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtwendtYW5jaWVlbWVmY3ZndGttIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAzODQyMTksImV4cCI6MjA5NTk2MDIxOX0.WviBlyBg9Ji9kARXUyP_87muq8oGLVX6_0T0FNtKqTI",Q={"Content-Type":"application/json",apikey:ve,Authorization:`Bearer ${ve}`,Prefer:"return=minimal"},ie="https://lemaitranmedia.github.io/eventoh-checkin";function be(e){return{id:e.id,name:e.name,date:e.date_str,team:e.team,venue:e.venue,eventPw:e.event_pw,btcMembers:e.btc_members||[],createdAt:e.created_at}}function xe(e){return{id:e.id,eventId:e.event_id,guestCode:e.guest_code,name:e.name,phone:e.phone,prmName:e.prm_name,tcbRegion:e.tcb_region,unit:e.unit,sihName:e.sih_name,note:e.note,companions:e.companions||[],checkedIn:!!e.checked_in,checkinTime:e.checkin_time,checkinBy:e.checkin_by,cancelled:!!e.cancelled,cancelNote:e.cancel_note,createdAt:e.created_at}}function ye(e){return{id:e.id,name:e.name,date_str:e.date||null,team:e.team||null,venue:e.venue||null,event_pw:e.eventPw||null,btc_members:e.btcMembers||[],created_at:e.createdAt||Date.now()}}function ke(e){return{id:e.id,event_id:e.eventId,guest_code:e.guestCode,name:e.name,phone:e.phone||null,prm_name:e.prmName||null,tcb_region:e.tcbRegion||null,unit:e.unit||null,sih_name:e.sihName||null,note:e.note||null,companions:e.companions||[],checked_in:!!e.checkedIn,checkin_time:e.checkinTime||null,checkin_by:e.checkinBy||null,cancelled:!!e.cancelled,cancel_note:e.cancelNote||null,created_at:e.createdAt||Date.now()}}function we(){try{const e=localStorage.getItem(ae);return e?JSON.parse(e):{events:[],guests:[]}}catch{return{events:[],guests:[]}}}async function $e(){try{const[e,t]=await Promise.all([fetch(`${J}/rest/v1/oh_events?select=*&order=created_at.desc`,{headers:Q}),fetch(`${J}/rest/v1/oh_guests?select=*`,{headers:Q})]),i=await e.json(),c=await t.json();if(Array.isArray(i)&&Array.isArray(c))return l.events=i.map(be),l.guests=c.map(xe),localStorage.setItem(ae,JSON.stringify(l)),!0}catch(e){console.warn("Supabase load lỗi, dùng localStorage:",e)}return!1}let W=null;function w(){try{localStorage.setItem(ae,JSON.stringify(l))}catch{}W&&clearTimeout(W),W=setTimeout(Ce,600)}async function Ce(){W=null;try{l.events.length&&await fetch(`${J}/rest/v1/oh_events`,{method:"POST",headers:{...Q,Prefer:"resolution=merge-duplicates"},body:JSON.stringify(l.events.map(ye))}),l.guests.length&&await fetch(`${J}/rest/v1/oh_guests`,{method:"POST",headers:{...Q,Prefer:"resolution=merge-duplicates"},body:JSON.stringify(l.guests.map(ke))})}catch(e){console.warn("Supabase sync lỗi:",e)}}async function ge(e,t){try{await fetch(`${J}/rest/v1/${e}?id=eq.${t}`,{method:"DELETE",headers:Q})}catch(i){console.warn("Supabase delete lỗi:",i)}}let l={events:[],guests:[]};function ee(e){return ie+"/?code="+encodeURIComponent(e)}async function re(){if(!await $e()){const t=we();l.events=t.events,l.guests=t.guests}}function R(e){return e!=null&&e.date?new Date().toISOString().slice(0,10)>e.date:!1}function oe(e){return l.events.find(t=>t.id===e)}let de=null;function Ie(){de&&clearInterval(de),de=setInterval(async()=>{await re(),u()},15e3)}async function Ee(){const e=document.getElementById("refresh_btn");e&&(e.textContent="⏳ Đang làm mới...",e.disabled=!0),await re(),u()}async function _e(){const e=new URLSearchParams(window.location.search).get("code"),t=document.getElementById("root");if(t.innerHTML=`<div style="max-width:360px;margin:80px auto;text-align:center;font-family:'Be Vietnam Pro',sans-serif"><div style="font-size:40px;margin-bottom:12px">⏳</div><div style="font-size:14px;color:#aaa;margin-top:8px">Đang tải...</div></div>`,await re(),e){n.urlCode=decodeURIComponent(e),n.view="url_ci",u();return}u(),e||Ie()}_e();let n={adminOk:!1,view:"admin",urlCode:null,urlCIStep:null,tab:"events",selEv:null,modal:null,editGid:null,delGid:null,ticketGid:null,editEvId:null,cpTicket:null,cpEdit:null,cpDel:null,cpAdd:null,adminCI:null,cancelTarget:null,unlockedEvs:{},evUnlockTarget:null,rptEv:null,rptExp:{},search:"",filter:"all",ciOk:!1,ciEv:null,ciOp:null,ciState:null,pwVal:"",pwErr:"",newEvBtcRows:1,newGCompRows:1,importData:null};function H(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function S(e){return e?new Date(e).toLocaleDateString("vi-VN"):"—"}function G(e){return e?new Date(e).toLocaleString("vi-VN"):"—"}function te(e){return e?new Date(e).toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}):""}function U(e){return l.guests.filter(t=>t.eventId===e)}function ce(e){let t=0,i=0,c=0;return U(e).forEach(o=>{t++,o.checkedIn&&i++,o.cancelled&&c++,(o.companions||[]).forEach(s=>{t++,s.checkedIn&&i++,s.cancelled&&c++})}),{t,c:i,x:c,p:t-i-c}}function K(e){const t=l.events.find(a=>a.id===e),i=t?t.name.replace(/[^A-Z0-9]/gi,"").toUpperCase().slice(0,3):"OH",c="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",o=new Set;l.guests.forEach(a=>{o.add(a.guestCode),(a.companions||[]).forEach(v=>o.add(v.code))});let s,d=0;do{s=i+"-";for(let a=0;a<4;a++)s+=c[Math.floor(Math.random()*c.length)];d++}while(o.has(s)&&d<200);return s}function Te(e,t){for(const i of l.guests.filter(c=>c.eventId===e)){if(i.guestCode===t)return{type:"guest",guest:i,person:i};for(const c of i.companions||[])if(c.code===t)return{type:"comp",guest:i,person:c}}return null}function u(){const e=document.getElementById("root");if(n.view==="url_ci"){e.innerHTML=tt(),nt();return}if(!n.adminOk){e.innerHTML=Be();return}if(n.view==="checkin"){e.innerHTML=ot(),ct();return}e.innerHTML=Me(),Se()}function Be(){return`<div class="login-box">
  ...
  </div>`}function ze(){var t;(((t=document.getElementById("login_pw"))==null?void 0:t.value)||"")===ne?(n.adminOk=!0,u()):document.getElementById("login_err").textContent="⚠️ Mật khẩu không đúng."}function Me(){return`
    ...
    ${n.tab==="guests"?Ae():""}
    ${n.tab==="report"?De():""}
    ${n.modal?Ve():""}`}function Se(){n.modal==="tickets"&&n.ticketGid&&(setTimeout(le,120),setTimeout(le,400)),n.modal==="cp_ticket"&&n.cpTicket&&(setTimeout(Z,120),setTimeout(Z,400))}function Ne(){const e=[...l.events].sort((t,i)=>new Date(i.date||0)-new Date(t.date||0));return`<div class="topbar"><div style="font-weight:700">Danh sách sự kiện</div>
    ...
    ${e.map(t=>{const i=ce(t.id),c=(t.btcMembers||[]).length,o=R(t);return`<div class="ev-item" onclick="openGM('${t.id}')">
      ...
      </div>`}).join("")}`}function Ae(){const e=`<select class="selx" onchange="pickEv(this.value)">
    <option value="">-- Chọn sự kiện --</option>
    ${l.events.map(d=>`<option value="${d.id}" ${n.selEv===d.id?"selected":""}>${d.name}</option>`).join("")}
  </select>`;if(!n.selEv)return`<div class="topbar">${e}</div><div class="empty">👆 Chọn sự kiện để quản lý khách mời</div>`;const t=l.events.find(d=>d.id===n.selEv);let i=U(n.selEv);const c=ce(n.selEv);if(n.search){const d=n.search.toLowerCase();i=i.filter(a=>{var v,m,h,r,f,b;return((v=a.name)==null?void 0:v.toLowerCase().includes(d))||((m=a.phone)==null?void 0:m.includes(d))||((h=a.prmName)==null?void 0:h.toLowerCase().includes(d))||((r=a.sihName)==null?void 0:r.toLowerCase().includes(d))||((f=a.unit)==null?void 0:f.toLowerCase().includes(d))||((b=a.guestCode)==null?void 0:b.toLowerCase().includes(d))||(a.companions||[]).some(y=>{var k,_;return((k=y.name)==null?void 0:k.toLowerCase().includes(d))||((_=y.code)==null?void 0:_.toLowerCase().includes(d))})})}n.filter==="checked"&&(i=i.filter(d=>d.checkedIn)),n.filter==="pending"&&(i=i.filter(d=>!d.checkedIn&&!d.cancelled)),n.filter==="cancelled"&&(i=i.filter(d=>d.cancelled));const o=(t.btcMembers||[]).map(d=>`<span class="badge b-purple" style="margin:2px">🔑 ${d.name} (${d.code})</span>`).join(""),s=R(t);return`
    <div class="topbar">
    ...
    <div class="card-tight">
      <div style="overflow-x:auto">
        <table class="tbl">
          ...
          ${i.map((d,a)=>{const v=d.companions||[],m=!!d.cancelled;let h=`<tr ${m?'class="cancelled"':""} style="${m?"background:#FFF8F8":""}">
              ...
              <td>
            ...
            </tr>`;return v.forEach(r=>{const f=!!r.cancelled;h+=`<tr ${f?'class="cancelled"':""} style="background:${f?"#FFF8F8":"#fafbfc"}">
                <td></td>
                ...
                <td>${f||s?'<span style="font-size:11px;color:#ccc">—</span>':`<button class="ci ${r.checkedIn?"on":"off"}" onclick="togCI('${d.id}','c','${r.id}')">${r.checkedIn?"✅ Vào":"⏳"}</button>
                   ${r.checkedIn?`<div style="font-size:10px;color:#bbb;margin-top:2px">${te(r.checkinTime)}</div>`:""}`}
                </td>
                <td>
                  <div style="display:flex;gap:2px;flex-wrap:wrap">
                    ${s?`<button class="btn xs" onclick="openCpTicket('${d.id}','${r.id}')" title="Vé">🎫</button>`:f?`<button class="btn xs" onclick="undoCancel('${d.id}','c','${r.id}')" style="color:#185FA5;border-color:#185FA5" title="Recall — người đi kèm quay lại">↩</button>`:`<button class="btn xs" onclick="openCpTicket('${d.id}','${r.id}')" title="Vé">🎫</button>
    ...
    ${c.t>0?'<div style="text-align:right;margin-top:6px"><button class="btn sm" onclick="expCSV()">⬇️ Xuất CSV</button></div>':""}`}function De(){if(!l.events.length)return'<div class="empty">Chưa có dữ liệu.</div>';const i=`
    ...
    ${l.events.map(p=>`<option value="${p.id}" ${n.rptEv===p.id?"selected":""}>${p.name}${p.eventPw&&!n.unlockedEvs[p.id]?" 🔒":""}${R(p)?" 🔐":""}</option>`).join("")}
      ...
      ${l.events.map(p=>{const x=ce(p.id),$=x.t?Math.round(x.c/x.t*100):0,M=p.eventPw&&!n.unlockedEvs[p.id];return`<div style="padding:10px 0;border-bottom:1px solid #f0f0f0">
  ...
  <div style="background:#fff;border-radius:12px;padding:14px 18px;margin-bottom:14px;border:1px solid #eaecf0">
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:8px">
      ...
      <span style="color:#3B6D11;font-weight:700">${h}%</span>
    </div>
    <div style="background:#f0f0f0;border-radius:99px;height:12px;overflow:hidden">
      <div style="width:${h}%;background:linear-gradient(90deg,#185FA5,#3B6D11);height:100%;border-radius:99px;transition:width .4s"></div>
    </div>
  </div>
  ...
  <div style="display:flex;gap:10px;margin-bottom:14px;flex-wrap:wrap">
    ${O("Tổng lượt đăng ký","#185FA5",r,f+" Main + "+b+" Companion")}
    ${O("✅ Tổng đã vào sảnh","#3B6D11",y,k+" Main + "+_+" Companion")}
    ${O("Avg companion / Main đã vào","#888",N,"")}
  </div>`;function B(p){const x=p.companions||[];if(!x.length)return"";const $=x.map(C=>C.checkedIn?"-1":"+1");return`<span style="font-size:12px;font-weight:600;color:${$.every(C=>C==="-1")?"#e24b4a":$.every(C=>C==="+1")?"#3B6D11":"#aaa"};white-space:nowrap;margin-left:8px">${$.join(" ")}</span>`}function z(p,x,$,M){const C={};o.forEach(P=>{const E=M(P)||"Không xác định";C[E]||(C[E]=[]),C[E].push(P)});const X=Object.entries(C).sort((P,E)=>E[1].length-P[1].length);return X.length?`<div style="font-size:11px;font-weight:700;color:#888;letter-spacing:1px;margin:16px 0 8px;text-transform:uppercase">${x} Theo ${p} (Main)</div>
      ${X.map(([P,E])=>{const D=E.filter(g=>g.checkedIn).length,q=E.filter(g=>g.cancelled).length,F=E.length-D-q,se=E.length>0?Math.round(D/E.length*100):0,j=`${$}_${P}`,pe=!!n.rptExp[j+"_ci"],ue=!!n.rptExp[j+"_ab"],me=!!n.rptExp[j+"_cn"];return`<div style="background:#fff;border-radius:12px;border:1px solid #eaecf0;padding:14px 16px;margin-bottom:8px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;flex-wrap:wrap;gap:6px">
            <div style="font-weight:700;font-size:13px">${P} <span style="font-weight:400;color:#aaa;font-size:11px">(${E.length} Main)</span></div>
            <div style="display:flex;gap:6px;font-size:12px;flex-wrap:wrap">
              <span onclick="togRpt('${j}_ci')" style="background:${D>0?"#eaf3de":"#f5f5f5"};color:${D>0?"#3B6D11":"#aaa"};border-radius:20px;padding:2px 10px;font-weight:600;cursor:${D>0?"pointer":"default"};user-select:none">
                Đã vào: ${D}${D>0?pe?" ▲":" ▼":""}
              </span>
              <span onclick="togRpt('${j}_ab')" style="background:${F>0?"#fdecea":"#f5f5f5"};color:${F>0?"#e24b4a":"#aaa"};border-radius:20px;padding:2px 10px;font-weight:600;cursor:${F>0?"pointer":"default"};user-select:none">
                Chưa: ${F}${F>0?ue?" ▲":" ▼":""}
              </span>
              ${q>0?`<span onclick="togRpt('${j}_cn')" style="background:#FEF2F2;color:#B91C1C;border-radius:20px;padding:2px 10px;font-weight:600;cursor:pointer;user-select:none">
                Cancel: ${q}${me?" ▲":" ▼"}
              </span>`:""}
            </div>
          </div>
          ...
          ${pe&&D>0?`<div style="background:#f0faf0;border:1px solid #97C459;border-radius:8px;padding:10px 12px;margin-top:8px">
            <div style="font-size:11px;font-weight:700;color:#3B6D11;margin-bottom:6px">Đã check-in (${D} Main)</div>
            ${E.filter(g=>g.checkedIn).map(g=>`<div style="padding:5px 0;border-bottom:.5px solid #c8e6c9;display:flex;justify-content:space-between;align-items:center">
              <div>
                <div style="font-weight:600;font-size:13px">${g.name}</div>
                <div style="font-size:11px;color:#888">${g.code}${g.phone?" · "+g.phone:""}</div>
                <div style="font-size:10px;color:#3B6D11">✅ ${te(g.checkinTime)}</div>
              </div>
              ${B(g)}
            </div>`).join("")}
          </div>`:""}
          ${ue&&F>0?`<div style="background:#fff8f8;border:1px solid #fdd;border-radius:8px;padding:10px 12px;margin-top:8px">
            <div style="font-size:11px;font-weight:700;color:#e24b4a;margin-bottom:6px">Chưa check-in (${F} Main)</div>
            ${E.filter(g=>!g.checkedIn&&!g.cancelled).map(g=>`<div style="padding:5px 0;border-bottom:.5px solid #fdd;display:flex;justify-content:space-between;align-items:center">
              <div>
                <div style="font-weight:600;font-size:13px">${g.name}</div>
                <div style="font-size:11px;color:#888">${g.code}${g.phone?" · "+g.phone:""}</div>
              </div>
          ...
          ${me&&q>0?`<div style="background:#FFF8F8;border:1px solid #FECACA;border-radius:8px;padding:10px 12px;margin-top:8px">
            <div style="font-size:11px;font-weight:700;color:#B91C1C;margin-bottom:6px">Đã cancel (${q} Main)</div>
            ${E.filter(g=>g.cancelled).map(g=>`<div style="padding:5px 0;border-bottom:.5px solid #FECACA;display:flex;justify-content:space-between;align-items:center">
              <div>
  ...
  </div>`}function Re(e){n.rptExp[e]=!n.rptExp[e],u()}function He(e){if(e){const t=l.events.find(i=>i.id===e);if(t!=null&&t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.rptEv=e,n.modal="ev_unlock",u();return}}n.rptEv=e||null,n.rptExp={},u()}function Ve(){const e=(t,i)=>`<div class="ov" onclick="closeM()"><div class="modal ${i||""}" onclick="event.stopPropagation()">${t}</div></div>`;return n.modal==="add_ev"||n.modal==="edit_ev"?e(Le(),"lg"):n.modal==="add_g"||n.modal==="edit_g"?e(Pe(),"lg"):n.modal==="tickets"?e(Oe(),"lg"):n.modal==="edit_pw"?e(Ke(),"sm"):n.modal==="edit_form"?e(je(),"lg"):n.modal==="del_pw"?e(Ge(),"sm"):n.modal==="cp_ticket"?e(Ue(),"sm"):n.modal==="cp_edit"?e(Xe(),"sm"):n.modal==="cp_del"?e(qe(),"sm"):n.modal==="cp_add"?e(Je()):n.modal==="admin_ci"?e(Qe(),"sm"):n.modal==="cancel"?e(Ze(),"sm"):n.modal==="ev_unlock"?e(Ye(),"sm"):n.modal==="import_preview"?e(et(),"lg"):""}function Le(){const e=n.modal==="edit_ev",t=e?l.events.find(c=>c.id===n.editEvId):{},i=(t==null?void 0:t.btcMembers)||[{code:"",name:""}];return`<div class="mh">${e?"✏️ Chỉnh sửa sự kiện":"📅 Tạo sự kiện mới"}</div>
    <div class="g2">
    ...
    <div id="cp_w">
      ${t.map((c,o)=>{var s,d;return Fe(c,o,(d=(s=e==null?void 0:e.companions)==null?void 0:s[o])==null?void 0:d.code)}).join("")}
    </div>
    ...
    </div>`}function Fe(e,t,i){return`<div class="cp-r" id="cr_${t}">
  ...
  </div>`}function Oe(){var c;const e=l.guests.find(o=>o.id===n.ticketGid);if(!e)return"";const t=l.events.find(o=>o.id===e.eventId),i=[{type:"main",name:e.name,code:e.guestCode,phone:e.phone},...(e.companions||[]).map(o=>({type:"comp",name:o.name,code:o.code,phone:o.phone,parentName:e.name}))];return`<div class="mh">🎫 Vé tham dự sự kiện</div>
    ...
    </div>`}function Ke(){return`<div class="mh">✏️ Xác nhận chỉnh sửa</div>
    ...
    </div>`}function je(){var i;const e=l.guests.find(c=>c.id===n.editGid);if(!e)return"";const t=(i=e.companions)!=null&&i.length?e.companions:[{name:"",phone:"",code:""}];return`<div class="mh">✏️ Chỉnh sửa — ${e.name}</div>
    ...
    </div>`}function Ge(){const e=l.guests.find(t=>t.id===n.delGid);return`<div class="mh">🗑️ Xoá khách hàng</div>
    ...
    </div>`}function Ue(){const{gid:e,cpId:t}=n.cpTicket||{},i=l.guests.find(s=>s.id===e),c=((i==null?void 0:i.companions)||[]).find(s=>s.id===t);if(!i||!c)return"";const o=l.events.find(s=>s.id===i.eventId);return`<div class="mh">🎫 Vé người đi kèm</div>
    ...
    <div class="mf" style="justify-content:center">
      ...
      <button class="btn" onclick="closeM()">Đóng</button>
    </div>`}function Xe(){const{gid:e,cpId:t}=n.cpEdit||{},i=l.guests.find(o=>o.id===e),c=((i==null?void 0:i.companions)||[]).find(o=>o.id===t);return!i||!c?"":`<div class="mh">✏️ Sửa người đi kèm</div>
    ...
    </div>`}function Je(){const e=l.guests.find(t=>t.id===n.cpAdd);return e?`<div class="mh">👤 Thêm người đi kèm</div>
    ...
    </div>`:""}function Qe(){var d;const{gid:e,type:t,cpId:i}=n.adminCI||{},c=l.guests.find(a=>a.id===e);if(!c)return"";const o=t==="c"?(c.companions||[]).find(a=>a.id===i):c;if(!o)return"";l.events.find(a=>a.id===c.eventId);const s=!!o.phone;return`<div class="mh">✅ Xác nhận Check-in</div>
    ...
    ${s?`
      ...
      </div>`}`}function Ze(){const{gid:e,type:t,cpId:i}=n.cancelTarget||{},c=l.guests.find(s=>s.id===e);if(!c)return"";const o=t==="c"?(c.companions||[]).find(s=>s.id===i):c;return o?`<div class="mh">🚫 Đánh dấu Cancel</div>
    ...
    </div>`:""}function Ye(){const e=l.events.find(t=>t.id===n.evUnlockTarget);return e?`<div class="mh">🔒 Nhập mật khẩu sự kiện</div>
  ...
  `}function tt(){const e=n.urlCode;let t=null;for(const d of l.guests){if(d.guestCode===e){t={type:"guest",guest:d,person:d};break}for(const a of d.companions||[])if(a.code===e){t={type:"comp",guest:d,person:a};break}if(t)break}const i=t?l.events.find(d=>{var a;return d.id===((a=t==null?void 0:t.guest)==null?void 0:a.eventId)}):null;if(!t)return`<div style="max-width:400px;margin:60px auto;padding:24px;text-align:center;font-family:'Be Vietnam Pro',sans-serif">
  ...
  </div>`}function nt(){setTimeout(()=>{const e=document.getElementById("uci_phone")||document.getElementById("uci_btc");e&&e.focus()},80)}async function it(){var m,h;const e=n.urlCode;let t=null;for(const r of l.guests){if(r.guestCode===e){t={type:"guest",guest:r,person:r};break}for(const f of r.companions||[])if(f.code===e){t={type:"comp",guest:r,person:f};break}if(t)break}if(!t)return;const i=t.person,c=t.guest,o=l.events.find(r=>r.id===c.eventId);if(R(o)){const r=document.getElementById("uci_err");r&&(r.textContent="⚠️ Sự kiện đã kết thúc. Không thể check-in.");return}const s=(((m=document.getElementById("uci_btc"))==null?void 0:m.value)||"").toUpperCase().trim();if(!((o==null?void 0:o.btcMembers)||[]).find(r=>r.code===s)){const r=document.getElementById("uci_err");r&&(r.textContent="⚠️ Mã BTC không đúng hoặc không thuộc sự kiện này.");return}const a=i.phone?i.phone.replace(/\D/g,"").slice(-4):"";if(a&&(((h=document.getElementById("uci_phone"))==null?void 0:h.value)||"").trim()!==a){const f=document.getElementById("uci_err");f&&(f.textContent="⚠️ 4 số cuối SĐT không khớp.");const b=document.getElementById("uci_phone");b&&(b.value="",b.focus());return}const v=new Date().toISOString();t.type==="guest"?(c.checkedIn=!0,c.checkinTime=v,c.checkinBy=s):(i.checkedIn=!0,i.checkinTime=v,i.checkinBy=s),w(),n.urlCIStep="done",u()}function ot(){if(!n.ciOk)return st();if(!n.ciState)return he();const e=n.ciState;return e.step==="verify"?dt():e.step==="done"?lt():e.step==="err"?at():he()}function ct(){setTimeout(()=>{const e=document.getElementById("ci_in")||document.getElementById("ci_ph")||document.getElementById("lock_c");e&&e.focus()},80)}function st(){return`<div class="lock">
  ...
  </div>`}function dt(){const e=n.ciState,t=e.person,i=e.guest;return`<div class="ci-screen">
  ...
  </div>`}function lt(){const e=n.ciState,t=e.person,i=e.guest,c=l.events.find(o=>o.id===i.eventId);return`<div class="ci-screen"><div class="big-result">
    <div class="icon">🎉</div>
    <div style="font-size:22px;font-weight:800;color:#0C447C;margin-bottom:10px">Check-in thành công!</div>
  ...
  </div></div>`}function at(){return`<div class="ci-screen"><div class="big-result">
    <div class="icon">❌</div>
  ...
  </div></div>`}function rt(e){n.tab=e,u()}function pt(e){const t=l.events.find(i=>i.id===e);if(t){if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",u();return}n.selEv=e,n.tab="guests",n.search="",n.filter="all",u()}}function ut(e){if(!e){n.selEv=null,n.search="",n.filter="all",u();return}const t=l.events.find(i=>i.id===e);if(t){if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",u();return}n.selEv=e,n.search="",n.filter="all",u()}}function mt(e){n.search=e,u()}function vt(e){n.filter=e,u()}function ht(e){n.modal=e,u()}function ft(e){n.editGid=e,n.modal="edit_pw",u()}function gt(e){n.delGid=e,n.modal="del_pw",u()}function bt(e){n.ticketGid=e,n.modal="tickets",u()}function Y(){n.modal=null,n.editGid=null,n.delGid=null,n.cpTicket=null,n.cpEdit=null,n.cpDel=null,n.cpAdd=null,n.adminCI=null,n.cancelTarget=null,n.evUnlockTarget=null,n.editEvId=null,n.importData=null,u()}function xt(e){const t=l.events.find(i=>i.id===e);if(t){if(R(t)){alert("Sự kiện đã kết thúc. Không thể chỉnh sửa thông tin sự kiện.");return}if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",u();return}n.editEvId=e,n.modal="edit_ev",u()}}function yt(e,t){n.cpTicket={gid:e,cpId:t},n.modal="cp_ticket",u(),setTimeout(()=>Z(),120)}function kt(e,t){n.cpEdit={gid:e,cpId:t},n.modal="cp_edit",u()}function wt(e,t){n.cpDel={gid:e,cpId:t},n.modal="cp_del",u()}function $t(e){n.cpAdd=e,n.modal="cp_add",u()}function Ct(e,t,i){n.cancelTarget={gid:e,type:t,cpId:i||null},n.modal="cancel",u()}function It(){var s;const{gid:e,type:t,cpId:i}=n.cancelTarget||{},c=l.guests.find(d=>d.id===e);if(!c)return;if(R(oe(c.eventId))){alert("Sự kiện đã kết thúc. Không thể thay đổi."),Y();return}const o=(((s=document.getElementById("cancel_note"))==null?void 0:s.value)||"").trim();if(t==="c"){const d=(c.companions||[]).find(a=>a.id===i);d&&(d.cancelled=!0,d.cancelNote=o,d.checkedIn=!1,d.checkinTime=null)}else c.cancelled=!0,c.cancelNote=o,c.checkedIn=!1,c.checkinTime=null,(c.companions||[]).forEach(d=>{d.cancelled=!0,d.cancelNote=o?`[Theo KH chính] ${o}`:"Theo KH chính",d.checkedIn=!1,d.checkinTime=null});w(),n.modal=null,n.cancelTarget=null,u()}function Et(e,t,i){const c=l.guests.find(o=>o.id===e);if(c){if(t==="c"){const o=(c.companions||[]).find(s=>s.id===i);o&&(o.cancelled=!1,o.cancelNote="")}else c.cancelled=!1,c.cancelNote="",(c.companions||[]).forEach(o=>{o.cancelled=!1,o.cancelNote=""});w(),u()}}function _t(){n.view="checkin",n.ciOk=!1,n.ciEv=null,n.ciOp=null,n.ciState=null,u()}function Tt(){n.view="admin",n.ciOk=!1,n.ciState=null,u()}function Bt(){n.ciOk=!1,n.ciOp=null,n.ciState=null,u()}function zt(){n.ciState=null,u()}function Mt(){n.ciState=null,u()}function St(){const e=document.getElementById("btc_w");if(!e)return;const t=e.querySelectorAll(".btc-r").length,i=document.createElement("div");i.className="btc-r",i.id="br_"+t,i.innerHTML=`<input placeholder="Mã NV" id="bc_${t}" style="max-width:110px;font-family:'JetBrains Mono',monospace;text-transform:uppercase"/>
    <input placeholder="Họ tên BTC" id="bn_${t}"/>
    <button class="btn xs red" onclick="rmBR(${t})" style="flex-shrink:0">✕</button>`,e.appendChild(i)}function Nt(e){const t=document.getElementById("br_"+e);t&&t.remove()}function At(){const e=document.getElementById("btc_w");if(!e)return[];const t=[];return e.querySelectorAll(".btc-r").forEach(i=>{var s,d;const c=(((s=i.querySelector("input:first-child"))==null?void 0:s.value)||"").toUpperCase().trim(),o=(((d=i.querySelector("input:nth-child(2)"))==null?void 0:d.value)||"").trim();c&&o&&t.push({code:c,name:o})}),t}function Dt(){const e=document.getElementById("cp_w");if(!e)return;const t=e.querySelectorAll(".cp-r").length,i=document.createElement("div");i.id="cr_"+t,i.className="cp-r",i.innerHTML=`<div class="g2" style="margin-bottom:0">
  ...
  </div><button class="btn xs red" onclick="rmCR(${t})" style="margin-top:6px">Xoá đi kèm này</button>`,document.getElementById("cp_w").appendChild(i)}function Rt(e){const t=document.getElementById("cr_"+e);t&&t.remove()}function Ht(e){const t=document.getElementById("cp_w");if(!t)return[];const i=[];return t.querySelectorAll(".cp-r").forEach(c=>{var v,m;const o=c.id.replace(/[^0-9]/g,""),s="c",d=(((v=document.getElementById(s+"n_"+o))==null?void 0:v.value)||"").trim(),a=(((m=document.getElementById(s+"p_"+o))==null?void 0:m.value)||"").trim();d&&i.push({name:d,phone:a})}),i}function Vt(){var m,h,r,f,b,y,k,_,N;const e=n.modal==="edit_ev",t=(h=(m=document.getElementById("ev_n"))==null?void 0:m.value)==null?void 0:h.trim(),i=(r=document.getElementById("ev_d"))==null?void 0:r.value,c=(b=(f=document.getElementById("ev_t"))==null?void 0:f.value)==null?void 0:b.trim(),o=(k=(y=document.getElementById("ev_v"))==null?void 0:y.value)==null?void 0:k.trim(),s=(((_=document.getElementById("ev_pw"))==null?void 0:_.value)||"").trim(),d=(((N=document.getElementById("ev_pw2"))==null?void 0:N.value)||"").trim(),a=At();if(!t){alert("Vui lòng nhập tên sự kiện");return}if(!a.length){alert("Cần ít nhất 1 thành viên BTC");return}const v=document.getElementById("ev_pw_err");if(e){if(s&&s!==d){v&&(v.textContent="⚠️ Mật khẩu nhập lại không khớp");return}const I=l.events.findIndex(A=>A.id===n.editEvId);if(I<0)return;const B=l.events[I],z=s||B.eventPw;l.events[I]={...B,name:t,date:i,team:c,venue:o,eventPw:z,btcMembers:a},s&&(n.unlockedEvs[n.editEvId]=!0),w(),n.modal=null,n.editEvId=null,u()}else{if(!s){v&&(v.textContent="⚠️ Vui lòng đặt mật khẩu cho sự kiện");return}if(s!==d){v&&(v.textContent="⚠️ Mật khẩu nhập lại không khớp");return}const I={id:H(),name:t,date:i,team:c,venue:o,eventPw:s,btcMembers:a,createdAt:Date.now()};l.events.push(I),n.unlockedEvs[I.id]=!0,n.selEv=I.id,w(),n.modal=null,n.tab="guests",u()}}function Lt(e){confirm("Xoá sự kiện này? Toàn bộ khách cũng bị xoá.")&&(l.events=l.events.filter(t=>t.id!==e),l.guests=l.guests.filter(t=>t.eventId!==e),n.selEv===e&&(n.selEv=null),w(),ge("oh_events",e),u())}function Pt(){var m,h,r,f,b,y,k,_,N,I,B,z,A,V,L;const e=(m=document.getElementById("g_ev"))==null?void 0:m.value,t=(r=(h=document.getElementById("g_n"))==null?void 0:h.value)==null?void 0:r.trim(),i=(b=(f=document.getElementById("g_ph"))==null?void 0:f.value)==null?void 0:b.trim(),c=(k=(y=document.getElementById("g_prm"))==null?void 0:y.value)==null?void 0:k.trim(),o=(N=(_=document.getElementById("g_reg"))==null?void 0:_.value)==null?void 0:N.trim(),s=(B=(I=document.getElementById("g_unit"))==null?void 0:I.value)==null?void 0:B.trim(),d=(A=(z=document.getElementById("g_sih"))==null?void 0:z.value)==null?void 0:A.trim(),a=(L=(V=document.getElementById("g_note"))==null?void 0:V.value)==null?void 0:L.trim();if(!t){alert("Vui lòng nhập họ tên KH");return}if(!e){alert("Vui lòng chọn sự kiện");return}if(R(oe(e))){alert("Sự kiện đã kết thúc. Không thể thêm/sửa khách."),Y();return}const v=Ht();if(n.modal==="edit_g"&&n.editGid){const T=l.guests.findIndex(p=>p.id===n.editGid);if(T>-1){const p=l.guests[T],x=p.companions||[],$=v.map(M=>{const C=x.find(X=>X.name===M.name&&X.code);return C?{...C,phone:M.phone}:{id:H(),name:M.name,phone:M.phone,code:K(e),checkedIn:!1,checkinTime:null,checkinBy:null}});l.guests[T]={...p,eventId:e,name:t,phone:i,prmName:c,tcbRegion:o,unit:s,sihName:d,note:a,companions:$},n.ticketGid=n.editGid}}else{const T=K(e),p=v.map($=>({id:H(),name:$.name,phone:$.phone,code:K(e),checkedIn:!1,checkinTime:null,checkinBy:null})),x={id:H(),eventId:e,guestCode:T,name:t,phone:i,prmName:c,tcbRegion:o,unit:s,sihName:d,note:a,companions:p,checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()};l.guests.push(x),n.ticketGid=x.id}n.selEv=e,w(),n.editGid=null,n.modal="tickets",u()}function Ft(){var t;if((((t=document.getElementById("epw"))==null?void 0:t.value)||"")===ne)n.modal="edit_form",u();else{const i=document.getElementById("epw_err");i&&(i.textContent="⚠️ Mật khẩu không đúng.")}}function Ot(){var h,r,f,b,y,k,_,N,I,B,z,A,V,L;const e=l.guests.find(T=>T.id===n.editGid);if(!e)return;const t=l.guests.indexOf(e),i=((r=(h=document.getElementById("eg_n"))==null?void 0:h.value)==null?void 0:r.trim())||e.name,c=((b=(f=document.getElementById("eg_ph"))==null?void 0:f.value)==null?void 0:b.trim())||e.phone,o=(k=(y=document.getElementById("eg_prm"))==null?void 0:y.value)==null?void 0:k.trim(),s=(N=(_=document.getElementById("eg_reg"))==null?void 0:_.value)==null?void 0:N.trim(),d=(B=(I=document.getElementById("eg_unit"))==null?void 0:I.value)==null?void 0:B.trim(),a=(A=(z=document.getElementById("eg_sih"))==null?void 0:z.value)==null?void 0:A.trim(),v=(L=(V=document.getElementById("eg_note"))==null?void 0:V.value)==null?void 0:L.trim(),m=(e.companions||[]).map((T,p)=>{var x,$,M,C;return{...T,name:(($=(x=document.getElementById("ecn_"+p))==null?void 0:x.value)==null?void 0:$.trim())||T.name,phone:((C=(M=document.getElementById("ecp_"+p))==null?void 0:M.value)==null?void 0:C.trim())||T.phone}});l.guests[t]={...e,name:i,phone:c,prmName:o,tcbRegion:s,unit:d,sihName:a,note:v,companions:m},w(),n.modal=null,n.editGid=null,u()}function Kt(){var i;if((((i=document.getElementById("dpw"))==null?void 0:i.value)||"")!==ne){const c=document.getElementById("dpw_err");c&&(c.textContent="⚠️ Mật khẩu không đúng.");return}const t=n.delGid;l.guests=l.guests.filter(c=>c.id!==t),w(),ge("oh_guests",t),n.modal=null,n.delGid=null,u()}function jt(){var a,v,m,h;const{gid:e,cpId:t}=n.cpEdit||{},i=l.guests.find(r=>r.id===e);if(!i)return;const c=l.guests.indexOf(i),o=(i.companions||[]).findIndex(r=>r.id===t);if(o<0)return;const s=(v=(a=document.getElementById("cpe_n"))==null?void 0:a.value)==null?void 0:v.trim(),d=(h=(m=document.getElementById("cpe_ph"))==null?void 0:m.value)==null?void 0:h.trim();if(!s){alert("Vui lòng nhập họ tên");return}l.guests[c].companions[o]={...l.guests[c].companions[o],name:s,phone:d},w(),n.modal=null,n.cpEdit=null,u()}function Gt(){var o;if((((o=document.getElementById("cpdpw"))==null?void 0:o.value)||"")!==ne){const s=document.getElementById("cpdpw_err");s&&(s.textContent="⚠️ Mật khẩu không đúng.");return}const{gid:t,cpId:i}=n.cpDel||{},c=l.guests.findIndex(s=>s.id===t);c<0||(l.guests[c].companions=(l.guests[c].companions||[]).filter(s=>s.id!==i),w(),n.modal=null,n.cpDel=null,u())}function Ut(){var s,d,a,v;const e=n.cpAdd,t=l.guests.findIndex(m=>m.id===e);if(t<0)return;const i=(d=(s=document.getElementById("cpa_n"))==null?void 0:s.value)==null?void 0:d.trim(),c=(v=(a=document.getElementById("cpa_ph"))==null?void 0:a.value)==null?void 0:v.trim();if(!i){alert("Vui lòng nhập họ tên");return}const o={id:H(),name:i,phone:c,code:K(l.guests[t].eventId),checkedIn:!1,checkinTime:null,checkinBy:null};l.guests[t].companions||(l.guests[t].companions=[]),l.guests[t].companions.push(o),w(),n.cpTicket={gid:e,cpId:o.id},n.cpAdd=null,n.modal="cp_ticket",u(),setTimeout(()=>Z(),120)}function Z(){const{gid:e,cpId:t}=n.cpTicket||{},i=l.guests.find(s=>s.id===e),c=((i==null?void 0:i.companions)||[]).find(s=>s.id===t);if(!c)return;const o=document.getElementById("cp_tqr");if(o){o.innerHTML="";try{new QRCode(o,{text:ee(c.code),width:160,height:160,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.M})}catch{o.innerHTML='<div style="font-size:11px;color:#aaa">QR error</div>'}}}function Xt(){const{gid:e,cpId:t}=n.cpTicket||{},i=l.guests.find(d=>d.id===e),c=((i==null?void 0:i.companions)||[]).find(d=>d.id===t);if(!i||!c)return;const o=l.events.find(d=>d.id===i.eventId);window.open("","_blank","width=440,height=560").document.write(`<!DOCTYPE html><html><head>
    ...
    *{box-sizing:border-box;margin:0;padding:0}body{font-family:'Be Vietnam Pro',sans-serif;padding:20px;background:#f5f7fb}
    ...
    <\/script>
  </body></html>`)}function Yt(){var o;const e=document.getElementById("lock_ev");if(n.ciEv=(e==null?void 0:e.value)||n.ciEv,!n.ciEv){document.getElementById("lock_err").textContent="⚠️ Vui lòng chọn sự kiện";return}const t=l.events.find(s=>s.id===n.ciEv);if(!t){document.getElementById("lock_err").textContent="Sự kiện không tồn tại";return}const i=(((o=document.getElementById("lock_c"))==null?void 0:o.value)||"").toUpperCase().trim();if(!i){document.getElementById("lock_err").textContent="⚠️ Vui lòng nhập mã nhân viên";return}const c=(t.btcMembers||[]).find(s=>s.code===i);if(!c){document.getElementById("lock_err").textContent="⚠️ Mã không nằm trong danh sách BTC của sự kiện này";return}n.ciOk=!0,n.ciOp=c,n.ciState=null,u()}function Wt(){var c,o;const e=(((c=document.getElementById("ci_in"))==null?void 0:c.value)||"").toUpperCase().trim();if(!e){document.getElementById("ci_err").textContent="⚠️ Vui lòng nhập mã";return}const t=Te(n.ciEv,e);if(!t){document.getElementById("ci_err").textContent="⚠️ Không tìm thấy mã trong sự kiện này";return}const i=t.person;if(i.checkedIn){document.getElementById("ci_err").textContent="⚠️ Đã check-in lúc "+G(i.checkinTime);return}if(!i.phone){i.checkedIn=!0,i.checkinTime=new Date().toISOString(),i.checkinBy=((o=n.ciOp)==null?void 0:o.code)||"btc",w(),n.ciState={step:"done",type:t.type,guest:t.guest,person:i,code:e},u();return}n.ciState={step:"verify",type:t.type,guest:t.guest,person:i,code:e},u()}function en(){var o;const e=(((o=document.getElementById("ci_ph"))==null?void 0:o.value)||"").trim(),i=n.ciState.person,c=i.phone?i.phone.replace(/\D/g,"").slice(-4):"";if(!c){fe();return}if(e===c)fe();else{const s=document.getElementById("ph_err");s&&(s.textContent="⚠️ 4 số cuối không khớp. Vui lòng thử lại.");const d=document.getElementById("ci_ph");d&&(d.value="",d.focus())}}function fe(){var i,c;const e=n.ciState,t=l.guests.find(o=>o.id===e.guest.id);if(!t){n.ciState={step:"err",msg:"Lỗi hệ thống"},u();return}if(e.type==="guest")t.checkedIn=!0,t.checkinTime=new Date().toISOString(),t.checkinBy=((i=n.ciOp)==null?void 0:i.code)||"btc";else{const o=(t.companions||[]).find(s=>s.id===e.person.id);o&&(o.checkedIn=!0,o.checkinTime=new Date().toISOString(),o.checkinBy=((c=n.ciOp)==null?void 0:c.code)||"btc")}w(),n.ciState={step:"done",type:e.type,guest:t,person:e.type==="guest"?t:(t.companions||[]).find(o=>o.id===e.person.id),code:e.code},u()}function tn(){const e=l.events.find(s=>s.id===n.selEv),t=[["STT","Loại","Mã","Họ tên","SĐT","KH gốc (nếu đi kèm)","PRM","Vùng TCB","Đơn vị","SIH","Note","Trạng thái","Giờ check-in","BTC","Lý do cancel"]];let i=0;U(n.selEv).forEach(s=>{i++;const d=s.cancelled?"Cancel":s.checkedIn?"Đã vào":"Chưa";t.push([i,"KH chính",s.guestCode,s.name,s.phone||"","",s.prmName||"",s.tcbRegion||"",s.unit||"",s.sihName||"",s.note||"",d,s.checkinTime?G(s.checkinTime):"",s.checkinBy||"",s.cancelNote||""]),(s.companions||[]).forEach(a=>{i++;const v=a.cancelled?"Cancel":a.checkedIn?"Đã vào":"Chưa";t.push([i,"Đi kèm",a.code,a.name,a.phone||"",s.name,s.prmName||"",s.tcbRegion||"","","","",v,a.checkinTime?G(a.checkinTime):"",a.checkinBy||"",a.cancelNote||""])})});const c=t.map(s=>s.map(d=>`"${String(d).replace(/"/g,'""')}"`).join(",")).join(`
`),o=document.createElement("a");o.href=URL.createObjectURL(new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8"})),o.download=`checkin_${((e==null?void 0:e.name)||"").replace(/[^a-zA-Z0-9]/g,"_")}_${new Date().toISOString().slice(0,10)}.csv`,o.click()}function nn(){const e=[["Loại Khách (Gõ 'Main' hoặc 'Companion')","Họ và Tên (*)","Số Điện Thoại","Tên PRM (Sales TCB)","Vùng TCB","Đơn vị (CN/PGD)","Tên SIH (Sales OH)","Note / Lưu ý"]],t=[["Main","Nguyễn Văn A","0901234567","Lê PRM","Vùng 1","CN Sài Gòn","Trần SIH","Khách VIP bàn đầu"],["Companion","Nguyễn Văn B (Đi kèm A)","0907654321","","","","","Đi cùng xe ông A"],["Main","Phạm Thị C","0911223344","Nguyễn PRM","Vùng 2","CN Hà Nội","Vũ SIH",""]],i=XLSX.utils.aoa_to_sheet(e.concat(t)),c=XLSX.utils.book_new();XLSX.utils.book_append_sheet(c,i,"Template"),XLSX.writeFile(c,"OneHousing_Template_ImportKhach.xlsx")}function on(){document.getElementById("excel_file_input").click()}function cn(e){const t=e.target.files[0];if(!t)return;const i=new FileReader;i.onload=function(c){try{const o=new Uint8Array(c.target.result),s=XLSX.read(o,{type:"array"}),d=s.SheetNames[0],a=s.Sheets[d],v=XLSX.utils.sheet_to_json(a,{header:1});if(v.length<=1){alert("File Excel trống hoặc thiếu dữ liệu!");return}const m=[];for(let h=1;h<v.length;h++){const r=v[h];!r[1]||String(r[1]).trim()===""||m.push({type:String(r[0]).trim().toLowerCase()==="companion"?"Companion":"Main",name:String(r[1]).trim(),phone:r[2]?String(r[2]).trim():"",prmName:r[3]?String(r[3]).trim():"",tcbRegion:r[4]?String(r[4]).trim():"",unit:r[5]?String(r[5]).trim():"",sihName:r[6]?String(r[6]).trim():"",note:r[7]?String(r[7]).trim():""})}if(m.length===0){alert("Không tìm thấy dữ liệu khách hàng hợp lệ trong file Excel!");return}n.importData=m,n.modal="import_preview",u()}catch(o){alert("Đã xảy ra lỗi khi đọc file Excel! Chi tiết: "+o.message)}e.target.value=""},i.readAsArrayBuffer(t)}function sn(){if(!n.selEv)return;const e=n.selEv,t=n.importData||[];let i=null;t.forEach(c=>{if(c.type==="Main"){const o=K(e);i={id:H(),eventId:e,guestCode:o,name:c.name,phone:c.phone,prmName:c.prmName,tcbRegion:c.tcbRegion,unit:c.unit,sihName:c.sihName,note:c.note,companions:[],checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()},l.guests.push(i)}else{const o={id:H(),name:c.name,phone:c.phone,code:K(e),checkedIn:!1,checkinTime:null,checkinBy:null};if(i)i.companions.push(o);else{const s=K(e);i={id:H(),eventId:e,guestCode:s,name:c.name+" (Chính)",phone:c.phone,prmName:c.prmName,tcbRegion:c.tcbRegion,unit:c.unit,sihName:c.sihName,note:"[Hệ thống tự dịch chuyển từ Companion độc lập] "+c.note,companions:[],checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()},l.guests.push(i)}}}),w(),alert("🎉 Đã import thành công danh sách khách mời từ Excel vào hệ thống!"),Y()}async function dn(){const e=l.events.find(m=>m.id===n.selEv),t=U(n.selEv);if(!t.length){alert("Sự kiện này chưa có khách mời nào để xuất QR!");return}const i=document.getElementById("zip_btn"),c=i.textContent;i.textContent="⏳ Đang khởi tạo bộ QR...",i.disabled=!0;const o=document.createElement("div");o.style.display="none",document.body.appendChild(o);const s=new JSZip,d=m=>new Promise(h=>{o.innerHTML="",new QRCode(o,{text:m,width:250,height:250,correctLevel:QRCode.CorrectLevel.M}),setTimeout(()=>{const r=o.querySelector("img");if(r&&r.src)h(r.src.split(",")[1]);else{const f=o.querySelector("canvas");h(f?f.toDataURL().split(",")[1]:null)}},50)}),a=new Map,v=(m,h,r)=>{let f=h.replace(/[/\\?%*:|"<>]/g,"-").trim(),b=`${m}_${f}_(${r})`;if(a.has(b)){let y=a.get(b)+1;return a.set(b,y),`${b}_${y}.png`}else return a.set(b,1),`${b}.png`};for(let m of t){const h=ee(m.guestCode),r=await d(h);if(r){const f=v(m.guestCode,m.name,"Chinh");s.file(f,r,{base64:!0})}if(m.companions&&m.companions.length)for(let f of m.companions){const b=ee(f.code),y=await d(b);if(y){const k=v(f.code,f.name,`DiKem_cua_${m.name}`);s.file(k,y,{base64:!0})}}}document.body.removeChild(o);try{const m=await s.generateAsync({type:"blob"}),h=document.createElement("a");h.href=URL.createObjectURL(m),h.download=`QR_SựKiện_${((e==null?void 0:e.name)||"Event").replace(/[^a-zA-Z0-9]/g,"_")}.zip`,h.click()}catch(m){alert("Có lỗi xảy ra trong quá trình nén file ZIP: "+m.message)}i.textContent=c,i.disabled=!1}window.R=u;window.doLogin=ze;window.doRefresh=Ee;window.doUrlCI=it;window.setTab=rt;window.openGM=pt;window.pickEv=ut;window.setSrch=mt;window.setFil=vt;window.openM=ht;window.openEdit=ft;window.openDel=gt;window.openTickets=bt;window.closeM=Y;window.openEditEv=xt;window.openCpTicket=yt;window.openCpEdit=kt;window.openCpDel=wt;window.openAddComp=$t;window.openCancel=Ct;window.doCancel=It;window.undoCancel=Et;window.goCI=_t;window.backAdmin=Tt;window.lockOut=Bt;window.cancelCI=zt;window.nextCI=Mt;window.addBR=St;window.rmBR=Nt;window.addCR=Dt;window.rmCR=Rt;window.saveEv=Vt;window.delEv=Lt;window.saveG=Pt;window.chkEditPw=Ft;window.doEdit=Ot;window.doDel=Kt;window.doCpEdit=jt;window.doCpDel=Gt;window.doCpAdd=Ut;window.mkQRs=le;window.mkCpQR=Z;window.dlTicket=Qt;window.dlCpTicket=Xt;window.printAll=Zt;window.tryUnlock=Yt;window.startCI=Wt;window.confirmPhone=en;window.doAdminCI=Jt;window.doEvUnlock=We;window.expCSV=tn;window.togCI=qt;window.togRpt=Re;window.setRptEv=He;window.triggerExcelImport=on;window.handleExcelImport=cn;window.downloadExcelTemplate=nn;window.commitExcelImport=sn;window.downloadAllQRsZip=dn;
