(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&c(d)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const ne="OH2026",ae="oh_ci_v5",U="https://kpzwmancieemefcvgtkm.supabase.co",ve="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtwendtYW5jaWVlbWVmY3ZndGttIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAzODQyMTksImV4cCI6MjA5NTk2MDIxOX0.WviBlyBg9Ji9kARXUyP_87muq8oGLVX6_0T0FNtKqTI",X={"Content-Type":"application/json",apikey:ve,Authorization:`Bearer ${ve}`,Prefer:"return=minimal"},ie="https://lemaitranmedia.github.io/eventoh-checkin";function xe(e){return{id:e.id,name:e.name,date:e.date_str,team:e.team,venue:e.venue,eventPw:e.event_pw,btcMembers:e.btc_members||[],createdAt:e.created_at}}function ye(e){return{id:e.id,eventId:e.event_id,guestCode:e.guest_code,systemCode:e.system_code,name:e.name,phone:e.phone,prmName:e.prm_name,tcbRegion:e.tcb_region,unit:e.unit,sihName:e.sih_name,note:e.note,companions:e.companions||[],checkedIn:!!e.checked_in,checkinTime:e.checkin_time,checkinBy:e.checkin_by,cancelled:!!e.cancelled,cancelNote:e.cancel_note,createdAt:e.created_at}}function ke(e){return{id:e.id,name:e.name,date_str:e.date||null,team:e.team||null,venue:e.venue||null,event_pw:e.eventPw||null,btc_members:e.btcMembers||[],created_at:e.createdAt||Date.now()}}function we(e){return{id:e.id,event_id:e.eventId,guest_code:e.guestCode,system_code:e.systemCode||null,name:e.name,phone:e.phone||null,prm_name:e.prmName||null,tcb_region:e.tcbRegion||null,unit:e.unit||null,sih_name:e.sihName||null,note:e.note||null,companions:e.companions||[],checked_in:!!e.checkedIn,checkin_time:e.checkinTime||null,checkin_by:e.checkinBy||null,cancelled:!!e.cancelled,cancel_note:e.cancelNote||null,created_at:e.createdAt||Date.now()}}function $e(){try{const e=localStorage.getItem(ae);return e?JSON.parse(e):{events:[],guests:[]}}catch{return{events:[],guests:[]}}}async function Ce(){try{const[e,t]=await Promise.all([fetch(`${U}/rest/v1/oh_events?select=*&order=created_at.desc`,{headers:X}),fetch(`${U}/rest/v1/oh_guests?select=*`,{headers:X})]),i=await e.json(),c=await t.json();if(Array.isArray(i)&&Array.isArray(c))return l.events=i.map(xe),l.guests=c.map(ye),localStorage.setItem(ae,JSON.stringify(l)),!0}catch(e){console.warn("Supabase load lỗi, dùng localStorage:",e)}return!1}let Y=null;function I(){try{localStorage.setItem(ae,JSON.stringify(l))}catch{}Y&&clearTimeout(Y),Y=setTimeout(Ie,600)}async function Ie(){Y=null;try{l.events.length&&await fetch(`${U}/rest/v1/oh_events`,{method:"POST",headers:{...X,Prefer:"resolution=merge-duplicates"},body:JSON.stringify(l.events.map(ke))}),l.guests.length&&await fetch(`${U}/rest/v1/oh_guests`,{method:"POST",headers:{...X,Prefer:"resolution=merge-duplicates"},body:JSON.stringify(l.guests.map(we))})}catch(e){console.warn("Supabase sync lỗi:",e)}}async function be(e,t){try{await fetch(`${U}/rest/v1/${e}?id=eq.${t}`,{method:"DELETE",headers:X})}catch(i){console.warn("Supabase delete lỗi:",i)}}async function re(e,t,i=3){for(let c=1;c<=i;c++){try{const o=await fetch(`${U}/rest/v1/oh_guests?id=eq.${e}`,{method:"PATCH",headers:{...X,Prefer:"return=minimal"},body:JSON.stringify(t)});if(o.ok)return!0;console.warn("sbPatchGuest lỗi HTTP",o.status)}catch(o){console.warn("sbPatchGuest lỗi mạng:",o)}c<i&&await new Promise(o=>setTimeout(o,c*500))}return!1}let l={events:[],guests:[]};function ee(e){return ie+"/?code="+encodeURIComponent(e)}async function pe(){if(!await Ce()){const t=$e();l.events=t.events,l.guests=t.guests}}function R(e){return e!=null&&e.date?new Date().toISOString().slice(0,10)>e.date:!1}function oe(e){return l.events.find(t=>t.id===e)}let de=null;function Ee(){de&&clearInterval(de),de=setInterval(async()=>{_e()||(await pe(),p())},15e3)}function _e(){var i;if(n.modal||((i=n.ciState)==null?void 0:i.step)==="verify"||n.urlCIBusy)return!0;const e=document.activeElement;if(!e)return!1;const t=e.tagName;return t==="INPUT"||t==="TEXTAREA"||t==="SELECT"}async function Te(){const e=document.getElementById("refresh_btn");e&&(e.textContent="⏳ Đang làm mới...",e.disabled=!0),await pe(),p()}async function Be(){const e=new URLSearchParams(window.location.search).get("code"),t=document.getElementById("root");if(t.innerHTML=`<div style="max-width:360px;margin:80px auto;text-align:center;font-family:'Be Vietnam Pro',sans-serif"><div style="font-size:40px;margin-bottom:12px">⏳</div><div style="font-size:14px;color:#aaa;margin-top:8px">Đang tải...</div></div>`,await pe(),e){n.urlCode=decodeURIComponent(e),n.view="url_ci",p();return}p(),e||Ee()}Be();let n={adminOk:!1,view:"admin",urlCode:null,urlCIStep:null,urlCIBusy:!1,urlCISyncWarn:!1,tab:"events",selEv:null,modal:null,editGid:null,delGid:null,ticketGid:null,editEvId:null,cpTicket:null,cpEdit:null,cpDel:null,cpAdd:null,adminCI:null,cancelTarget:null,unlockedEvs:{},evUnlockTarget:null,rptEv:null,rptExp:{},search:"",filter:"all",ciOk:!1,ciEv:null,ciOp:null,ciState:null,ciSyncWarn:!1,pwVal:"",pwErr:"",newEvBtcRows:1,newGCompRows:1,importData:null};function V(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function A(e){return e?new Date(e).toLocaleDateString("vi-VN"):"—"}function q(e){return e?new Date(e).toLocaleString("vi-VN"):"—"}function te(e){return e?new Date(e).toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}):""}function J(e){return l.guests.filter(t=>t.eventId===e)}function ce(e){let t=0,i=0,c=0;return J(e).forEach(o=>{t++,o.checkedIn&&i++,o.cancelled&&c++,(o.companions||[]).forEach(s=>{t++,s.checkedIn&&i++,s.cancelled&&c++})}),{t,c:i,x:c,p:t-i-c}}function G(e){const t=l.events.find(a=>a.id===e),i=t?t.name.replace(/[^A-Z0-9]/gi,"").toUpperCase().slice(0,3):"OH",c="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",o=new Set;l.guests.forEach(a=>{o.add(a.guestCode),(a.companions||[]).forEach(h=>o.add(h.code))});let s,d=0;do{s=i+"-";for(let a=0;a<4;a++)s+=c[Math.floor(Math.random()*c.length)];d++}while(o.has(s)&&d<200);return s}function ze(e,t){for(const i of l.guests.filter(c=>c.eventId===e)){if(i.guestCode===t)return{type:"guest",guest:i,person:i};for(const c of i.companions||[])if(c.code===t)return{type:"comp",guest:i,person:c}}return null}function p(){const e=document.getElementById("root");if(n.view==="url_ci"){e.innerHTML=it(),ot();return}if(!n.adminOk){e.innerHTML=Me();return}if(n.view==="checkin"){e.innerHTML=st(),dt();return}e.innerHTML=Ne(),Ae()}function Me(){return`<div class="login-box">
  ...
  </div>`}function Se(){var t;(((t=document.getElementById("login_pw"))==null?void 0:t.value)||"")===ne?(n.adminOk=!0,p()):document.getElementById("login_err").textContent="⚠️ Mật khẩu không đúng."}function Ne(){return`
    ...
    ${n.tab==="guests"?De():""}
    ${n.tab==="report"?Re():""}
    ${n.modal?Fe():""}`}function Ae(){n.modal==="tickets"&&n.ticketGid&&(setTimeout(le,120),setTimeout(le,400)),n.modal==="cp_ticket"&&n.cpTicket&&(setTimeout(W,120),setTimeout(W,400))}function He(){const e=[...l.events].sort((t,i)=>new Date(i.date||0)-new Date(t.date||0));return`<div class="topbar"><div style="font-weight:700">Danh sách sự kiện</div>
  ...
  </select>`;if(!n.selEv)return`<div class="topbar">${e}</div><div class="empty">👆 Chọn sự kiện để quản lý khách mời</div>`;const t=l.events.find(d=>d.id===n.selEv);let i=J(n.selEv);const c=ce(n.selEv);if(n.search){const d=n.search.toLowerCase();i=i.filter(a=>{var h,m,f,r,g,v,x;return((h=a.name)==null?void 0:h.toLowerCase().includes(d))||((m=a.phone)==null?void 0:m.includes(d))||((f=a.prmName)==null?void 0:f.toLowerCase().includes(d))||((r=a.sihName)==null?void 0:r.toLowerCase().includes(d))||((g=a.unit)==null?void 0:g.toLowerCase().includes(d))||((v=a.guestCode)==null?void 0:v.toLowerCase().includes(d))||((x=a.systemCode)==null?void 0:x.toLowerCase().includes(d))||(a.companions||[]).some(y=>{var T,z;return((T=y.name)==null?void 0:T.toLowerCase().includes(d))||((z=y.code)==null?void 0:z.toLowerCase().includes(d))})})}n.filter==="checked"&&(i=i.filter(d=>d.checkedIn)),n.filter==="pending"&&(i=i.filter(d=>!d.checkedIn&&!d.cancelled)),n.filter==="cancelled"&&(i=i.filter(d=>d.cancelled));const o=(t.btcMembers||[]).map(d=>`<span class="badge b-purple" style="margin:2px">🔑 ${d.name} (${d.code})</span>`).join(""),s=R(t);return`
    <div class="topbar">
    ...
    ${s?`<div style="background:#FEF2F2;border:1px solid #FECACA;border-radius:10px;padding:10px 14px;margin-bottom:12px;display:flex;align-items:center;gap:10px">
      ...
      <div><div style="font-weight:600;font-size:13px;color:#B91C1C">Sự kiện đã kết thúc — Chỉ xem, không thể thao tác</div>
        <div style="font-size:11px;color:#aaa">Tất cả chức năng check-in, thêm/sửa/xoá khách đã bị khoá kể từ ngày ${A(t.date)}</div>
      </div>
    </div>`:""}
    ...
    <div class="card-tight">
      <div style="overflow-x:auto">
        <table class="tbl">
          ...
          ${i.map((d,a)=>{const h=d.companions||[],m=!!d.cancelled;let f=`<tr ${m?'class="cancelled"':""} style="${m?"background:#FFF8F8":""}">
              ...
              <td><span class="mono">${d.guestCode}</span>${d.systemCode?`<div style="font-size:10px;color:#aaa;margin-top:2px">Mã HT: ${d.systemCode}</div>`:""}</td>
            ...
            </tr>`;return h.forEach(r=>{const g=!!r.cancelled;f+=`<tr ${g?'class="cancelled"':""} style="background:${g?"#FFF8F8":"#fafbfc"}">
                <td></td>
    ...
    ${l.events.map(u=>`<option value="${u.id}" ${n.rptEv===u.id?"selected":""}>${u.name}${u.eventPw&&!n.unlockedEvs[u.id]?" 🔒":""}${R(u)?" 🔐":""}</option>`).join("")}
  </select>`}
      </div>
      ${l.events.map(u=>{const k=ce(u.id),$=k.t?Math.round(k.c/k.t*100):0,B=u.eventPw&&!n.unlockedEvs[u.id];return`<div style="padding:10px 0;border-bottom:1px solid #f0f0f0">
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:6px">
            <div><div style="font-weight:600;font-size:13px">${u.name}${B?" 🔒":""}</div>
              <div style="font-size:11px;color:#aaa">${A(u.date)}${u.team?" · "+u.team:""}</div></div>
            <div style="display:flex;gap:10px;align-items:center">
              <div style="text-align:center"><div style="font-size:15px;font-weight:700">${k.t}</div><div style="font-size:10px;color:#aaa">Tổng</div></div>
              <div style="text-align:center"><div style="font-size:15px;font-weight:700;color:#3B6D11">${k.c}</div><div style="font-size:10px;color:#aaa">✅ Đã vào</div></div>
              <div style="text-align:center"><div style="font-size:15px;font-weight:700;color:#aaa">${k.p}</div><div style="font-size:10px;color:#aaa">⏳ Chưa</div></div>
              <div style="text-align:center"><div style="font-size:15px;font-weight:700;color:#B91C1C">${k.x}</div><div style="font-size:10px;color:#aaa">🚫 Cancel</div></div>
    ...
    </div>`;if(!n.rptEv)return i+'<div class="empty" style="padding:24px">☝️ Chọn sự kiện ở trên để xem báo cáo chi tiết</div>';const c=l.events.find(u=>u.id===n.rptEv);if(c!=null&&c.eventPw&&!n.unlockedEvs[n.rptEv])return i+`<div class="card" style="text-align:center;padding:24px">
    ...
    </div>`;const o=J(n.rptEv).map(u=>({name:u.name,code:u.guestCode,phone:u.phone,prmName:u.prmName,tcbRegion:u.tcbRegion,unit:u.unit,sihName:u.sihName,note:u.note,checkedIn:u.checkedIn,cancelled:u.cancelled,checkinTime:u.checkinTime,companions:u.companions||[]})),s=[];o.forEach(u=>{s.push({checkedIn:u.checkedIn,cancelled:u.cancelled,isMain:!0}),u.companions.forEach(k=>s.push({checkedIn:k.checkedIn,cancelled:k.cancelled,isMain:!1}))});const d=o.length,a=o.filter(u=>u.checkedIn).length,h=o.filter(u=>u.cancelled).length,m=d-a-h,f=d>0?Math.round(a/d*100):0,r=s.length,g=o.length,v=r-g,x=s.filter(u=>u.checkedIn).length,y=a,T=x-y,z=y>0?Math.round(T/y*100)/100:0,E=`<div style="font-size:11px;font-weight:700;color:#888;letter-spacing:1px;margin-bottom:8px;text-transform:uppercase">Tổng quan (Khách hàng - Main)</div>
  <div style="display:flex;gap:10px;margin-bottom:14px;flex-wrap:wrap">
    ${K("Tổng KH mời (Main)","#185FA5",d,"")}
    ${K("✅ KH đã tới","#3B6D11",a,f+"% turnout")}
    ${K("⏳ KH chưa tới","#888",m,"")}
    ${K("🚫 KH cancel","#B91C1C",h,"")}
  </div>
  ...
  <div style="display:flex;gap:10px;margin-bottom:14px;flex-wrap:wrap">
    ${K("Tổng lượt đăng ký","#185FA5",r,g+" Main + "+v+" Companion")}
    ${K("✅ Tổng đã vào sảnh","#3B6D11",x,y+" Main + "+T+" Companion")}
    ${K("Avg companion / Main đã vào","#888",z,"")}
  </div>`;function M(u){const k=u.companions||[];if(!k.length)return"";const $=k.map(C=>C.checkedIn?"-1":"+1");return`<span style="font-size:12px;font-weight:600;color:${$.every(C=>C==="-1")?"#e24b4a":$.every(C=>C==="+1")?"#3B6D11":"#aaa"};white-space:nowrap;margin-left:8px">${$.join(" ")}</span>`}function S(u,k,$,B){const C={};o.forEach(_=>{const w=B(_)||"Không xác định";C[w]||(C[w]=[]),C[w].push(_)});const H=Object.entries(C).sort((_,w)=>w[1].length-_[1].length);return H.length?`<div style="font-size:11px;font-weight:700;color:#888;letter-spacing:1px;margin:16px 0 8px;text-transform:uppercase">${k} Theo ${u} (Main)</div>
      ${H.map(([_,w])=>{const N=w.filter(b=>b.checkedIn).length,Q=w.filter(b=>b.cancelled).length,O=w.length-N-Q,se=w.length>0?Math.round(N/w.length*100):0,j=`${$}_${_}`,ue=!!n.rptExp[j+"_ci"],me=!!n.rptExp[j+"_ab"],he=!!n.rptExp[j+"_cn"];return`<div style="background:#fff;border-radius:12px;border:1px solid #eaecf0;padding:14px 16px;margin-bottom:8px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;flex-wrap:wrap;gap:6px">
            <div style="font-weight:700;font-size:13px">${_} <span style="font-weight:400;color:#aaa;font-size:11px">(${w.length} Main)</span></div>
            <div style="display:flex;gap:6px;font-size:12px;flex-wrap:wrap">
              <span onclick="togRpt('${j}_ci')" style="background:${N>0?"#eaf3de":"#f5f5f5"};color:${N>0?"#3B6D11":"#aaa"};border-radius:20px;padding:2px 10px;font-weight:600;cursor:${N>0?"pointer":"default"};user-select:none">
                Đã vào: ${N}${N>0?ue?" ▲":" ▼":""}
              </span>
              <span onclick="togRpt('${j}_ab')" style="background:${O>0?"#fdecea":"#f5f5f5"};color:${O>0?"#e24b4a":"#aaa"};border-radius:20px;padding:2px 10px;font-weight:600;cursor:${O>0?"pointer":"default"};user-select:none">
                Chưa: ${O}${O>0?me?" ▲":" ▼":""}
              </span>
          ...
          ${ue&&N>0?`<div style="background:#f0faf0;border:1px solid #97C459;border-radius:8px;padding:10px 12px;margin-top:8px">
            <div style="font-size:11px;font-weight:700;color:#3B6D11;margin-bottom:6px">Đã check-in (${N} Main)</div>
            ${w.filter(b=>b.checkedIn).map(b=>`<div style="padding:5px 0;border-bottom:.5px solid #c8e6c9;display:flex;justify-content:space-between;align-items:center">
              <div>
          ...
          ${me&&O>0?`<div style="background:#fff8f8;border:1px solid #fdd;border-radius:8px;padding:10px 12px;margin-top:8px">
            ...
            ${w.filter(b=>!b.checkedIn&&!b.cancelled).map(b=>`<div style="padding:5px 0;border-bottom:.5px solid #fdd;display:flex;justify-content:space-between;align-items:center">
              <div>
                <div style="font-weight:600;font-size:13px">${b.name}</div>
                <div style="font-size:11px;color:#888">${b.code}${b.phone?" · "+b.phone:""}</div>
              </div>
          ...
          ${he&&Q>0?`<div style="background:#FFF8F8;border:1px solid #FECACA;border-radius:8px;padding:10px 12px;margin-top:8px">
            ...
            ${w.filter(b=>b.cancelled).map(b=>`<div style="padding:5px 0;border-bottom:.5px solid #FECACA;display:flex;justify-content:space-between;align-items:center">
              <div>
        ...
        </div>`}).join("")}`:""}const D=S("Vùng TCB","🏦","vung",u=>u.tcbRegion),L=S("Chi nhánh","🏢","unit",u=>u.unit),F=S("SIH","👤","sih",u=>u.sihName),P=S("PRM","🤝","prm",u=>u.prmName);return i+E+D+L+F+P}function K(e,t,i,c){return`<div style="flex:1;min-width:120px;background:#fff;border-radius:12px;padding:14px 16px;border-left:4px solid ${t};border:1px solid #eaecf0;border-left-width:4px">
    ...
    <div class="g3">
      ...
      <div class="fg"><label>Mã Hệ thống <span style="font-weight:400;color:#aaa">(OneHousing)</span></label><input id="g_syscode" placeholder="VD: OH-00123" value="${(e==null?void 0:e.systemCode)||""}"/></div>
    </div>
    ...
    <div style="font-size:13px;color:#aaa;margin-bottom:4px">${(t==null?void 0:t.name)||""} · ${A(t==null?void 0:t.date)}</div>
    ...
    <div class="tgrid">
      ${i.map((o,s)=>`
        <div class="ticket">
          ...
          <div style="font-size:11px;color:#bbb;margin-bottom:12px">${A(t==null?void 0:t.date)}${t!=null&&t.venue?" · "+t.venue:""}</div>
    ...
    <div class="g3">
      ...
      <div class="fg"><label>Mã Hệ thống <span style="font-weight:400;color:#aaa">(OneHousing)</span></label><input id="eg_syscode" value="${e.systemCode||""}"/></div>
    </div>
    ...
    <div class="ticket" style="margin:8px 0">
      ...
      <div style="font-size:11px;color:#bbb;margin-bottom:12px">${A(o==null?void 0:o.date)}${o!=null&&o.venue?" · "+o.venue:""}</div>
    ...
    <div style="background:#f4f7fb;border-radius:10px;padding:14px;margin-bottom:16px">
      ...
      <div style="font-size:12px;color:#aaa;margin-top:3px">${A(e.date)}${e.team?" · "+e.team:""}</div>
    </div>
        ...
        <tbody>
          ${e.map(t=>`
            <tr>
              ...
              <td style="font-family:'JetBrains Mono',monospace;font-size:11px">${t.type==="Main"&&t.systemCode||"—"}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
  ...
  `}function it(){const e=n.urlCode;let t=null;for(const d of l.guests){if(d.guestCode===e){t={type:"guest",guest:d,person:d};break}for(const a of d.companions||[])if(a.code===e){t={type:"comp",guest:d,person:a};break}if(t)break}const i=t?l.events.find(d=>{var a;return d.id===((a=t==null?void 0:t.guest)==null?void 0:a.eventId)}):null;if(!t)return`<div style="max-width:400px;margin:60px auto;padding:24px;text-align:center;font-family:'Be Vietnam Pro',sans-serif">
      ...
      <div style="font-size:12px;color:#bbb;margin-top:12px">Ghi nhận lúc: ${q(c.checkinTime)}</div>
      ...
      <div style="font-size:12px;color:#aaa;margin-top:6px">Check-in lúc: ${q(c.checkinTime)}</div>
    ...
    <div style="text-align:center;margin-bottom:20px;padding-bottom:16px;border-bottom:1px solid #eaecf0">
      ...
      <div style="font-size:13px;color:#aaa">${A(i==null?void 0:i.date)}${i!=null&&i.venue?" · "+i.venue:""}</div>
    </div>
  ...
  </div>`}function ot(){setTimeout(()=>{const e=document.getElementById("uci_phone")||document.getElementById("uci_btc");e&&e.focus()},80)}async function ct(){var r,g;const e=n.urlCode;let t=null;for(const v of l.guests){if(v.guestCode===e){t={type:"guest",guest:v,person:v};break}for(const x of v.companions||[])if(x.code===e){t={type:"comp",guest:v,person:x};break}if(t)break}if(!t)return;const i=t.person,c=t.guest,o=l.events.find(v=>v.id===c.eventId);if(R(o)){const v=document.getElementById("uci_err");v&&(v.textContent="⚠️ Sự kiện đã kết thúc. Không thể check-in.");return}const s=(((r=document.getElementById("uci_btc"))==null?void 0:r.value)||"").toUpperCase().trim();if(!((o==null?void 0:o.btcMembers)||[]).find(v=>v.code===s)){const v=document.getElementById("uci_err");v&&(v.textContent="⚠️ Mã BTC không đúng hoặc không thuộc sự kiện này.");return}const a=i.phone?i.phone.replace(/\D/g,"").slice(-4):"";if(a&&(((g=document.getElementById("uci_phone"))==null?void 0:g.value)||"").trim()!==a){const x=document.getElementById("uci_err");x&&(x.textContent="⚠️ 4 số cuối SĐT không khớp.");const y=document.getElementById("uci_phone");y&&(y.value="",y.focus());return}if(n.urlCIBusy)return;n.urlCIBusy=!0,p();const h=new Date().toISOString();t.type==="guest"?(c.checkedIn=!0,c.checkinTime=h,c.checkinBy=s):(i.checkedIn=!0,i.checkinTime=h,i.checkinBy=s),I();const m=t.type==="guest"?{checked_in:!0,checkin_time:h,checkin_by:s}:{companions:c.companions||[]},f=await re(c.id,m);n.urlCIBusy=!1,n.urlCISyncWarn=!f,n.urlCIStep="done",p()}function st(){if(!n.ciOk)return lt();if(!n.ciState)return fe();const e=n.ciState;return e.step==="verify"?at():e.step==="done"?rt():e.step==="err"?pt():fe()}function dt(){setTimeout(()=>{const e=document.getElementById("ci_in")||document.getElementById("ci_ph")||document.getElementById("lock_c");e&&e.focus()},80)}function lt(){return`<div class="lock">
    ...
    <div class="fg"><label>Sự kiện</label><select id="lock_ev" style="width:100%" onchange="S.ciEv=this.value">
      <option value="">-- Chọn sự kiện --</option>
      ${l.events.map(e=>`<option value="${e.id}" ${n.ciEv===e.id?"selected":""}>${e.name} (${A(e.date)})</option>`).join("")}
    </select></div>
    ...
    <div style="font-size:12px;color:#bbb;margin-top:12px">Ghi nhận lúc: ${q(t.checkinTime)} · BTC: ${t.checkinBy||"—"}</div>
  ...
  </div></div>`}function ut(e){n.tab=e,p()}function mt(e){const t=l.events.find(i=>i.id===e);if(t){if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",p();return}n.selEv=e,n.tab="guests",n.search="",n.filter="all",p()}}function ht(e){if(!e){n.selEv=null,n.search="",n.filter="all",p();return}const t=l.events.find(i=>i.id===e);if(t){if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",p();return}n.selEv=e,n.search="",n.filter="all",p()}}function vt(e){n.search=e,p()}function ft(e){n.filter=e,p()}function gt(e){n.modal=e,p()}function bt(e){n.editGid=e,n.modal="edit_pw",p()}function xt(e){n.delGid=e,n.modal="del_pw",p()}function yt(e){n.ticketGid=e,n.modal="tickets",p()}function Z(){n.modal=null,n.editGid=null,n.delGid=null,n.cpTicket=null,n.cpEdit=null,n.cpDel=null,n.cpAdd=null,n.adminCI=null,n.cancelTarget=null,n.evUnlockTarget=null,n.editEvId=null,n.importData=null,p()}function kt(e){const t=l.events.find(i=>i.id===e);if(t){if(R(t)){alert("Sự kiện đã kết thúc. Không thể chỉnh sửa thông tin sự kiện.");return}if(t.eventPw&&!n.unlockedEvs[e]){n.evUnlockTarget=e,n.modal="ev_unlock",p();return}n.editEvId=e,n.modal="edit_ev",p()}}function wt(e,t){n.cpTicket={gid:e,cpId:t},n.modal="cp_ticket",p(),setTimeout(()=>W(),120)}function $t(e,t){n.cpEdit={gid:e,cpId:t},n.modal="cp_edit",p()}function Ct(e,t){n.cpDel={gid:e,cpId:t},n.modal="cp_del",p()}function It(e){n.cpAdd=e,n.modal="cp_add",p()}function Et(e,t,i){n.cancelTarget={gid:e,type:t,cpId:i||null},n.modal="cancel",p()}function _t(){var s;const{gid:e,type:t,cpId:i}=n.cancelTarget||{},c=l.guests.find(d=>d.id===e);if(!c)return;if(R(oe(c.eventId))){alert("Sự kiện đã kết thúc. Không thể thay đổi."),Z();return}const o=(((s=document.getElementById("cancel_note"))==null?void 0:s.value)||"").trim();if(t==="c"){const d=(c.companions||[]).find(a=>a.id===i);d&&(d.cancelled=!0,d.cancelNote=o,d.checkedIn=!1,d.checkinTime=null)}else c.cancelled=!0,c.cancelNote=o,c.checkedIn=!1,c.checkinTime=null,(c.companions||[]).forEach(d=>{d.cancelled=!0,d.cancelNote=o?`[Theo KH chính] ${o}`:"Theo KH chính",d.checkedIn=!1,d.checkinTime=null});I(),n.modal=null,n.cancelTarget=null,p()}function Tt(e,t,i){const c=l.guests.find(o=>o.id===e);if(c){if(t==="c"){const o=(c.companions||[]).find(s=>s.id===i);o&&(o.cancelled=!1,o.cancelNote="")}else c.cancelled=!1,c.cancelNote="",(c.companions||[]).forEach(o=>{o.cancelled=!1,o.cancelNote=""});I(),p()}}function Bt(){n.view="checkin",n.ciOk=!1,n.ciEv=null,n.ciOp=null,n.ciState=null,p()}function zt(){n.view="admin",n.ciOk=!1,n.ciState=null,p()}function Mt(){n.ciOk=!1,n.ciOp=null,n.ciState=null,p()}function St(){n.ciState=null,n.ciSyncWarn=!1,p()}function Nt(){n.ciState=null,n.ciSyncWarn=!1,p()}function At(){const e=document.getElementById("btc_w");if(!e)return;const t=e.querySelectorAll(".btc-r").length,i=document.createElement("div");i.className="btc-r",i.id="br_"+t,i.innerHTML=`<input placeholder="Mã NV" id="bc_${t}" style="max-width:110px;font-family:'JetBrains Mono',monospace;text-transform:uppercase"/>
    <input placeholder="Họ tên BTC" id="bn_${t}"/>
    <button class="btn xs red" onclick="rmBR(${t})" style="flex-shrink:0">✕</button>`,e.appendChild(i)}function Ht(e){const t=document.getElementById("br_"+e);t&&t.remove()}function Dt(){const e=document.getElementById("btc_w");if(!e)return[];const t=[];return e.querySelectorAll(".btc-r").forEach(i=>{var s,d;const c=(((s=i.querySelector("input:first-child"))==null?void 0:s.value)||"").toUpperCase().trim(),o=(((d=i.querySelector("input:nth-child(2)"))==null?void 0:d.value)||"").trim();c&&o&&t.push({code:c,name:o})}),t}function Rt(){const e=document.getElementById("cp_w");if(!e)return;const t=e.querySelectorAll(".cp-r").length,i=document.createElement("div");i.id="cr_"+t,i.className="cp-r",i.innerHTML=`<div class="g2" style="margin-bottom:0">
  ...
  </div><button class="btn xs red" onclick="rmCR(${t})" style="margin-top:6px">Xoá đi kèm này</button>`,document.getElementById("cp_w").appendChild(i)}function Vt(e){const t=document.getElementById("cr_"+e);t&&t.remove()}function Lt(e){const t=document.getElementById("cp_w");if(!t)return[];const i=[];return t.querySelectorAll(".cp-r").forEach(c=>{var h,m;const o=c.id.replace(/[^0-9]/g,""),s="c",d=(((h=document.getElementById(s+"n_"+o))==null?void 0:h.value)||"").trim(),a=(((m=document.getElementById(s+"p_"+o))==null?void 0:m.value)||"").trim();d&&i.push({name:d,phone:a})}),i}function Ft(){var m,f,r,g,v,x,y,T,z;const e=n.modal==="edit_ev",t=(f=(m=document.getElementById("ev_n"))==null?void 0:m.value)==null?void 0:f.trim(),i=(r=document.getElementById("ev_d"))==null?void 0:r.value,c=(v=(g=document.getElementById("ev_t"))==null?void 0:g.value)==null?void 0:v.trim(),o=(y=(x=document.getElementById("ev_v"))==null?void 0:x.value)==null?void 0:y.trim(),s=(((T=document.getElementById("ev_pw"))==null?void 0:T.value)||"").trim(),d=(((z=document.getElementById("ev_pw2"))==null?void 0:z.value)||"").trim(),a=Dt();if(!t){alert("Vui lòng nhập tên sự kiện");return}if(!a.length){alert("Cần ít nhất 1 thành viên BTC");return}const h=document.getElementById("ev_pw_err");if(e){if(s&&s!==d){h&&(h.textContent="⚠️ Mật khẩu nhập lại không khớp");return}const E=l.events.findIndex(D=>D.id===n.editEvId);if(E<0)return;const M=l.events[E],S=s||M.eventPw;l.events[E]={...M,name:t,date:i,team:c,venue:o,eventPw:S,btcMembers:a},s&&(n.unlockedEvs[n.editEvId]=!0),I(),n.modal=null,n.editEvId=null,p()}else{if(!s){h&&(h.textContent="⚠️ Vui lòng đặt mật khẩu cho sự kiện");return}if(s!==d){h&&(h.textContent="⚠️ Mật khẩu nhập lại không khớp");return}const E={id:V(),name:t,date:i,team:c,venue:o,eventPw:s,btcMembers:a,createdAt:Date.now()};l.events.push(E),n.unlockedEvs[E.id]=!0,n.selEv=E.id,I(),n.modal=null,n.tab="guests",p()}}function Pt(e){confirm("Xoá sự kiện này? Toàn bộ khách cũng bị xoá.")&&(l.events=l.events.filter(t=>t.id!==e),l.guests=l.guests.filter(t=>t.eventId!==e),n.selEv===e&&(n.selEv=null),I(),be("oh_events",e),p())}function Ot(){var f,r,g,v,x,y,T,z,E,M,S,D,L,F,P,u,k;const e=(f=document.getElementById("g_ev"))==null?void 0:f.value,t=(g=(r=document.getElementById("g_n"))==null?void 0:r.value)==null?void 0:g.trim(),i=(x=(v=document.getElementById("g_ph"))==null?void 0:v.value)==null?void 0:x.trim(),c=(T=(y=document.getElementById("g_syscode"))==null?void 0:y.value)==null?void 0:T.trim(),o=(E=(z=document.getElementById("g_prm"))==null?void 0:z.value)==null?void 0:E.trim(),s=(S=(M=document.getElementById("g_reg"))==null?void 0:M.value)==null?void 0:S.trim(),d=(L=(D=document.getElementById("g_unit"))==null?void 0:D.value)==null?void 0:L.trim(),a=(P=(F=document.getElementById("g_sih"))==null?void 0:F.value)==null?void 0:P.trim(),h=(k=(u=document.getElementById("g_note"))==null?void 0:u.value)==null?void 0:k.trim();if(!t){alert("Vui lòng nhập họ tên KH");return}if(!e){alert("Vui lòng chọn sự kiện");return}if(R(oe(e))){alert("Sự kiện đã kết thúc. Không thể thêm/sửa khách."),Z();return}const m=Lt();if(n.modal==="edit_g"&&n.editGid){const $=l.guests.findIndex(B=>B.id===n.editGid);if($>-1){const B=l.guests[$],C=B.companions||[],H=m.map(_=>{const w=C.find(N=>N.name===_.name&&N.code);return w?{...w,phone:_.phone}:{id:V(),name:_.name,phone:_.phone,code:G(e),checkedIn:!1,checkinTime:null,checkinBy:null}});l.guests[$]={...B,eventId:e,name:t,phone:i,systemCode:c,prmName:o,tcbRegion:s,unit:d,sihName:a,note:h,companions:H},n.ticketGid=n.editGid}}else{const $=G(e),B=m.map(H=>({id:V(),name:H.name,phone:H.phone,code:G(e),checkedIn:!1,checkinTime:null,checkinBy:null})),C={id:V(),eventId:e,guestCode:$,systemCode:c,name:t,phone:i,prmName:o,tcbRegion:s,unit:d,sihName:a,note:h,companions:B,checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()};l.guests.push(C),n.ticketGid=C.id}n.selEv=e,I(),n.editGid=null,n.modal="tickets",p()}function Kt(){var t;if((((t=document.getElementById("epw"))==null?void 0:t.value)||"")===ne)n.modal="edit_form",p();else{const i=document.getElementById("epw_err");i&&(i.textContent="⚠️ Mật khẩu không đúng.")}}function Gt(){var r,g,v,x,y,T,z,E,M,S,D,L,F,P,u,k;const e=l.guests.find($=>$.id===n.editGid);if(!e)return;const t=l.guests.indexOf(e),i=((g=(r=document.getElementById("eg_n"))==null?void 0:r.value)==null?void 0:g.trim())||e.name,c=((x=(v=document.getElementById("eg_ph"))==null?void 0:v.value)==null?void 0:x.trim())||e.phone,o=(T=(y=document.getElementById("eg_syscode"))==null?void 0:y.value)==null?void 0:T.trim(),s=(E=(z=document.getElementById("eg_prm"))==null?void 0:z.value)==null?void 0:E.trim(),d=(S=(M=document.getElementById("eg_reg"))==null?void 0:M.value)==null?void 0:S.trim(),a=(L=(D=document.getElementById("eg_unit"))==null?void 0:D.value)==null?void 0:L.trim(),h=(P=(F=document.getElementById("eg_sih"))==null?void 0:F.value)==null?void 0:P.trim(),m=(k=(u=document.getElementById("eg_note"))==null?void 0:u.value)==null?void 0:k.trim(),f=(e.companions||[]).map(($,B)=>{var C,H,_,w;return{...$,name:((H=(C=document.getElementById("ecn_"+B))==null?void 0:C.value)==null?void 0:H.trim())||$.name,phone:((w=(_=document.getElementById("ecp_"+B))==null?void 0:_.value)==null?void 0:w.trim())||$.phone}});l.guests[t]={...e,name:i,phone:c,systemCode:o,prmName:s,tcbRegion:d,unit:a,sihName:h,note:m,companions:f},I(),n.modal=null,n.editGid=null,p()}function jt(){var i;if((((i=document.getElementById("dpw"))==null?void 0:i.value)||"")!==ne){const c=document.getElementById("dpw_err");c&&(c.textContent="⚠️ Mật khẩu không đúng.");return}const t=n.delGid;l.guests=l.guests.filter(c=>c.id!==t),I(),be("oh_guests",t),n.modal=null,n.delGid=null,p()}function Ut(){var a,h,m,f;const{gid:e,cpId:t}=n.cpEdit||{},i=l.guests.find(r=>r.id===e);if(!i)return;const c=l.guests.indexOf(i),o=(i.companions||[]).findIndex(r=>r.id===t);if(o<0)return;const s=(h=(a=document.getElementById("cpe_n"))==null?void 0:a.value)==null?void 0:h.trim(),d=(f=(m=document.getElementById("cpe_ph"))==null?void 0:m.value)==null?void 0:f.trim();if(!s){alert("Vui lòng nhập họ tên");return}l.guests[c].companions[o]={...l.guests[c].companions[o],name:s,phone:d},I(),n.modal=null,n.cpEdit=null,p()}function Xt(){var o;if((((o=document.getElementById("cpdpw"))==null?void 0:o.value)||"")!==ne){const s=document.getElementById("cpdpw_err");s&&(s.textContent="⚠️ Mật khẩu không đúng.");return}const{gid:t,cpId:i}=n.cpDel||{},c=l.guests.findIndex(s=>s.id===t);c<0||(l.guests[c].companions=(l.guests[c].companions||[]).filter(s=>s.id!==i),I(),n.modal=null,n.cpDel=null,p())}function qt(){var s,d,a,h;const e=n.cpAdd,t=l.guests.findIndex(m=>m.id===e);if(t<0)return;const i=(d=(s=document.getElementById("cpa_n"))==null?void 0:s.value)==null?void 0:d.trim(),c=(h=(a=document.getElementById("cpa_ph"))==null?void 0:a.value)==null?void 0:h.trim();if(!i){alert("Vui lòng nhập họ tên");return}const o={id:V(),name:i,phone:c,code:G(l.guests[t].eventId),checkedIn:!1,checkinTime:null,checkinBy:null};l.guests[t].companions||(l.guests[t].companions=[]),l.guests[t].companions.push(o),I(),n.cpTicket={gid:e,cpId:o.id},n.cpAdd=null,n.modal="cp_ticket",p(),setTimeout(()=>W(),120)}function W(){const{gid:e,cpId:t}=n.cpTicket||{},i=l.guests.find(s=>s.id===e),c=((i==null?void 0:i.companions)||[]).find(s=>s.id===t);if(!c)return;const o=document.getElementById("cp_tqr");if(o){o.innerHTML="";try{new QRCode(o,{text:ee(c.code),width:160,height:160,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.M})}catch{o.innerHTML='<div style="font-size:11px;color:#aaa">QR error</div>'}}}function Jt(){const{gid:e,cpId:t}=n.cpTicket||{},i=l.guests.find(d=>d.id===e),c=((i==null?void 0:i.companions)||[]).find(d=>d.id===t);if(!i||!c)return;const o=l.events.find(d=>d.id===i.eventId);window.open("","_blank","width=440,height=560").document.write(`<!DOCTYPE html><html><head>
    ...
    <div class="tk"><div class="hd">VÉ THAM DỰ SỰ KIỆN</div>
      ...
      <div class="ev" style="margin-bottom:12px">${A(o==null?void 0:o.date)}${o!=null&&o.venue?" · "+o.venue:""}</div>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    <div class="ticket" id="tk">
      ...
      <div class="ev" style="margin-bottom:12px">${A(s==null?void 0:s.date)}${s!=null&&s.venue?" · "+s.venue:""}</div>
    ...
    *{box-sizing:border-box;margin:0;padding:0}body{font-family:'Be Vietnam Pro',sans-serif;padding:20px;background:#f5f7fb}
    ...
    ${i.map(o=>`<div class="ticket">
      ...
      <div class="ev" style="margin-bottom:12px">${A(t==null?void 0:t.date)}${t!=null&&t.venue?" · "+t.venue:""}</div>
    ...
    <\/script>
  </body></html>`)}function en(){var o;const e=document.getElementById("lock_ev");if(n.ciEv=(e==null?void 0:e.value)||n.ciEv,!n.ciEv){document.getElementById("lock_err").textContent="⚠️ Vui lòng chọn sự kiện";return}const t=l.events.find(s=>s.id===n.ciEv);if(!t){document.getElementById("lock_err").textContent="Sự kiện không tồn tại";return}const i=(((o=document.getElementById("lock_c"))==null?void 0:o.value)||"").toUpperCase().trim();if(!i){document.getElementById("lock_err").textContent="⚠️ Vui lòng nhập mã nhân viên";return}const c=(t.btcMembers||[]).find(s=>s.code===i);if(!c){document.getElementById("lock_err").textContent="⚠️ Mã không nằm trong danh sách BTC của sự kiện này";return}n.ciOk=!0,n.ciOp=c,n.ciState=null,p()}async function tn(){var c,o;const e=(((c=document.getElementById("ci_in"))==null?void 0:c.value)||"").toUpperCase().trim();if(!e){document.getElementById("ci_err").textContent="⚠️ Vui lòng nhập mã";return}const t=ze(n.ciEv,e);if(!t){document.getElementById("ci_err").textContent="⚠️ Không tìm thấy mã trong sự kiện này";return}const i=t.person;if(i.checkedIn){document.getElementById("ci_err").textContent="⚠️ Đã check-in lúc "+q(i.checkinTime);return}if(!i.phone){const s=new Date().toISOString();i.checkedIn=!0,i.checkinTime=s,i.checkinBy=((o=n.ciOp)==null?void 0:o.code)||"btc",I();const d=t.type==="guest"?{checked_in:!0,checkin_time:s,checkin_by:i.checkinBy}:{companions:t.guest.companions||[]},a=await re(t.guest.id,d);n.ciSyncWarn=!a,n.ciState={step:"done",type:t.type,guest:t.guest,person:i,code:e},p();return}n.ciState={step:"verify",type:t.type,guest:t.guest,person:i,code:e},p()}function nn(){var o;const e=(((o=document.getElementById("ci_ph"))==null?void 0:o.value)||"").trim(),i=n.ciState.person,c=i.phone?i.phone.replace(/\D/g,"").slice(-4):"";if(!c){ge();return}if(e===c)ge();else{const s=document.getElementById("ph_err");s&&(s.textContent="⚠️ 4 số cuối không khớp. Vui lòng thử lại.");const d=document.getElementById("ci_ph");d&&(d.value="",d.focus())}}async function ge(){var d;const e=n.ciState,t=l.guests.find(a=>a.id===e.guest.id);if(!t){n.ciState={step:"err",msg:"Lỗi hệ thống"},p();return}const i=new Date().toISOString(),c=((d=n.ciOp)==null?void 0:d.code)||"btc";if(e.type==="guest")t.checkedIn=!0,t.checkinTime=i,t.checkinBy=c;else{const a=(t.companions||[]).find(h=>h.id===e.person.id);a&&(a.checkedIn=!0,a.checkinTime=i,a.checkinBy=c)}I();const o=e.type==="guest"?{checked_in:!0,checkin_time:i,checkin_by:c}:{companions:t.companions||[]},s=await re(t.id,o);n.ciSyncWarn=!s,n.ciState={step:"done",type:e.type,guest:t,person:e.type==="guest"?t:(t.companions||[]).find(a=>a.id===e.person.id),code:e.code},p()}function on(){const e=l.events.find(s=>s.id===n.selEv),t=[["STT","Loại","Mã","Mã Hệ thống","Họ tên","SĐT","KH gốc (nếu đi kèm)","PRM","Vùng TCB","Đơn vị","SIH","Note","Trạng thái","Giờ check-in","BTC","Lý do cancel"]];let i=0;J(n.selEv).forEach(s=>{i++;const d=s.cancelled?"Cancel":s.checkedIn?"Đã vào":"Chưa";t.push([i,"KH chính",s.guestCode,s.systemCode||"",s.name,s.phone||"","",s.prmName||"",s.tcbRegion||"",s.unit||"",s.sihName||"",s.note||"",d,s.checkinTime?q(s.checkinTime):"",s.checkinBy||"",s.cancelNote||""]),(s.companions||[]).forEach(a=>{i++;const h=a.cancelled?"Cancel":a.checkedIn?"Đã vào":"Chưa";t.push([i,"Đi kèm",a.code,"",a.name,a.phone||"",s.name,s.prmName||"",s.tcbRegion||"","","","",h,a.checkinTime?q(a.checkinTime):"",a.checkinBy||"",a.cancelNote||""])})});const c=t.map(s=>s.map(d=>`"${String(d).replace(/"/g,'""')}"`).join(",")).join(`
`),o=document.createElement("a");o.href=URL.createObjectURL(new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8"})),o.download=`checkin_${((e==null?void 0:e.name)||"").replace(/[^a-zA-Z0-9]/g,"_")}_${new Date().toISOString().slice(0,10)}.csv`,o.click()}function cn(){const e=[["Loại Khách (Gõ 'Main' hoặc 'Companion')","Họ và Tên (*)","Số Điện Thoại","Tên PRM (Sales TCB)","Vùng TCB","Đơn vị (CN/PGD)","Tên SIH (Sales OH)","Note / Lưu ý","Mã Hệ thống (OneHousing - chỉ áp dụng cho Main)"]],t=[["Main","Nguyễn Văn A","0901234567","Lê PRM","Vùng 1","CN Sài Gòn","Trần SIH","Khách VIP bàn đầu","OH-00123"],["Companion","Nguyễn Văn B (Đi kèm A)","0907654321","","","","","Đi cùng xe ông A",""],["Main","Phạm Thị C","0911223344","Nguyễn PRM","Vùng 2","CN Hà Nội","Vũ SIH","","OH-00456"]],i=XLSX.utils.aoa_to_sheet(e.concat(t)),c=XLSX.utils.book_new();XLSX.utils.book_append_sheet(c,i,"Template"),XLSX.writeFile(c,"OneHousing_Template_ImportKhach.xlsx")}function sn(){document.getElementById("excel_file_input").click()}function dn(e){const t=e.target.files[0];if(!t)return;const i=new FileReader;i.onload=function(c){try{const o=new Uint8Array(c.target.result),s=XLSX.read(o,{type:"array"}),d=s.SheetNames[0],a=s.Sheets[d],h=XLSX.utils.sheet_to_json(a,{header:1});if(h.length<=1){alert("File Excel trống hoặc thiếu dữ liệu!");return}const m=[];for(let f=1;f<h.length;f++){const r=h[f];!r[1]||String(r[1]).trim()===""||m.push({type:String(r[0]).trim().toLowerCase()==="companion"?"Companion":"Main",name:String(r[1]).trim(),phone:r[2]?String(r[2]).trim():"",prmName:r[3]?String(r[3]).trim():"",tcbRegion:r[4]?String(r[4]).trim():"",unit:r[5]?String(r[5]).trim():"",sihName:r[6]?String(r[6]).trim():"",note:r[7]?String(r[7]).trim():"",systemCode:r[8]?String(r[8]).trim():""})}if(m.length===0){alert("Không tìm thấy dữ liệu khách hàng hợp lệ trong file Excel!");return}n.importData=m,n.modal="import_preview",p()}catch(o){alert("Đã xảy ra lỗi khi đọc file Excel! Chi tiết: "+o.message)}e.target.value=""},i.readAsArrayBuffer(t)}function ln(){if(!n.selEv)return;const e=n.selEv,t=n.importData||[];let i=null;t.forEach(c=>{if(c.type==="Main"){const o=G(e);i={id:V(),eventId:e,guestCode:o,systemCode:c.systemCode,name:c.name,phone:c.phone,prmName:c.prmName,tcbRegion:c.tcbRegion,unit:c.unit,sihName:c.sihName,note:c.note,companions:[],checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()},l.guests.push(i)}else{const o={id:V(),name:c.name,phone:c.phone,code:G(e),checkedIn:!1,checkinTime:null,checkinBy:null};if(i)i.companions.push(o);else{const s=G(e);i={id:V(),eventId:e,guestCode:s,systemCode:c.systemCode,name:c.name+" (Chính)",phone:c.phone,prmName:c.prmName,tcbRegion:c.tcbRegion,unit:c.unit,sihName:c.sihName,note:"[Hệ thống tự dịch chuyển từ Companion độc lập] "+c.note,companions:[],checkedIn:!1,checkinTime:null,checkinBy:null,createdAt:Date.now()},l.guests.push(i)}}}),I(),alert("🎉 Đã import thành công danh sách khách mời từ Excel vào hệ thống!"),Z()}async function an(){const e=l.events.find(m=>m.id===n.selEv),t=J(n.selEv);if(!t.length){alert("Sự kiện này chưa có khách mời nào để xuất QR!");return}const i=document.getElementById("zip_btn"),c=i.textContent;i.textContent="⏳ Đang khởi tạo bộ QR...",i.disabled=!0;const o=document.createElement("div");o.style.display="none",document.body.appendChild(o);const s=new JSZip,d=m=>new Promise(f=>{o.innerHTML="",new QRCode(o,{text:m,width:250,height:250,correctLevel:QRCode.CorrectLevel.M}),setTimeout(()=>{const r=o.querySelector("img");if(r&&r.src)f(r.src.split(",")[1]);else{const g=o.querySelector("canvas");f(g?g.toDataURL().split(",")[1]:null)}},50)}),a=new Map,h=(m,f,r)=>{let g=f.replace(/[/\\?%*:|"<>]/g,"-").trim(),v=`${m}_${g}_(${r})`;if(a.has(v)){let x=a.get(v)+1;return a.set(v,x),`${v}_${x}.png`}else return a.set(v,1),`${v}.png`};for(let m of t){const f=ee(m.guestCode),r=await d(f);if(r){const g=h(m.guestCode,m.name,"Chinh");s.file(g,r,{base64:!0})}if(m.companions&&m.companions.length)for(let g of m.companions){const v=ee(g.code),x=await d(v);if(x){const y=h(g.code,g.name,`DiKem_cua_${m.name}`);s.file(y,x,{base64:!0})}}}document.body.removeChild(o);try{const m=await s.generateAsync({type:"blob"}),f=document.createElement("a");f.href=URL.createObjectURL(m),f.download=`QR_SựKiện_${((e==null?void 0:e.name)||"Event").replace(/[^a-zA-Z0-9]/g,"_")}.zip`,f.click()}catch(m){alert("Có lỗi xảy ra trong quá trình nén file ZIP: "+m.message)}i.textContent=c,i.disabled=!1}window.R=p;window.doLogin=Se;window.doRefresh=Te;window.doUrlCI=ct;window.setTab=ut;window.openGM=mt;window.pickEv=ht;window.setSrch=vt;window.setFil=ft;window.openM=gt;window.openEdit=bt;window.openDel=xt;window.openTickets=yt;window.closeM=Z;window.openEditEv=kt;window.openCpTicket=wt;window.openCpEdit=$t;window.openCpDel=Ct;window.openAddComp=It;window.openCancel=Et;window.doCancel=_t;window.undoCancel=Tt;window.goCI=Bt;window.backAdmin=zt;window.lockOut=Mt;window.cancelCI=St;window.nextCI=Nt;window.addBR=At;window.rmBR=Ht;window.addCR=Rt;window.rmCR=Vt;window.saveEv=Ft;window.delEv=Pt;window.saveG=Ot;window.chkEditPw=Kt;window.doEdit=Gt;window.doDel=jt;window.doCpEdit=Ut;window.doCpDel=Xt;window.doCpAdd=qt;window.mkQRs=le;window.mkCpQR=W;window.dlTicket=Zt;window.dlCpTicket=Jt;window.printAll=Yt;window.tryUnlock=en;window.startCI=tn;window.confirmPhone=nn;window.doAdminCI=Wt;window.doEvUnlock=tt;window.expCSV=on;window.togCI=Qt;window.togRpt=Ve;window.setRptEv=Le;window.triggerExcelImport=sn;window.handleExcelImport=dn;window.downloadExcelTemplate=cn;window.commitExcelImport=ln;window.downloadAllQRsZip=an;
